...
public class AclfRptSubrptControlRec {
	...
	/**
	 * @param funcloadSubreport the funcloadSubreport to set
	 */
	...
	/**
	 * @param pqLimitSubreport the pqLimitSubreport to set
	 */
	...
	/**
	 * @param psxfrPControlSubreport the psxfrPControlSubreport to set
	 */
	...
	/**
	 * @param pvLimitSubreport the pvLimitSubreport to set
	 */
	...
	/**
	 * @param remoteQBusSubreport the remoteQBusSubreport to set
	 */
	...
	/**
	 * @param tapVControlSubreport the tapVControlSubreport to set
	 */
