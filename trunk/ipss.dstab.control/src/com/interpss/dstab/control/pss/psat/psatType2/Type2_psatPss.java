...
package com.interpss.dstab.control.pss.psat.psatType2;
...
public class Type2_psatPss extends AbstractStabilizer {
	// state variables
	private double 	x1 = 0.0, x2 = 0.0;
	private LimitType limit = null;

	// UI Editor panel
	private static final NBType2_psatPssEditPanel _editPanel = new NBType2_psatPssEditPanel();
	
	public Type2_psatPss() {
	 ...
	 * @param name pss name
	 */	
	public Type2_psatPss(final String id, final String name) {
		super(id, name);
		// _data is defined in the parent class. However init it here is a MUST
		_data = new Type2_psatPssData();
	}
	 ...
	 */
	public Type2_psatPssData getData() {
		return (Type2_psatPssData)_data;
	}
	...
	public void setDataXmlString(final String xmlString) {
		...
		_data = XmlUtil.toObject(xmlString, Type2_psatPssData.class);
	}
