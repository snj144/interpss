...
package com.interpss.dstab.control.pss.psat.psatType4;
...
public class Type4_psatPss extends AbstractStabilizer {
	// state variables
	private double 	x1 = 0.0, x2 = 0.0;
	private LimitType limit = null;

	// UI Editor panel
	private static final NBType4_psatPssEditPanel _editPanel = new NBType4_psatPssEditPanel();
	
	public Type4_psatPss() {
	 ...
	 * @param name pss name
	 */	
	public Type4_psatPss(final String id, final String name) {
		super(id, name);
		// _data is defined in the parent class. However init it here is a MUST
		_data = new Type4_psatPssData();
	}
	 ...
	 */
	public Type4_psatPssData getData() {
		return (Type4_psatPssData)_data;
	}
	...
	public void setDataXmlString(final String xmlString) {
		...
		_data = XmlUtil.toObject(xmlString, Type4_psatPssData.class);
	}
