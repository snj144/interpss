...
package com.interpss.dstab.control.pss.psat.psatType5;
...
public class Type5_psatPss extends AbstractStabilizer {
	// state variables
	private double 	x1 = 0.0, x2 = 0.0;
	private LimitType limit = null;

	// UI Editor panel
	private static final NBType5_psatPssEditPanel _editPanel = new NBType5_psatPssEditPanel();
	
	public Type5_psatPss() {
	 ...
	 * @param name pss name
	 */	
	public Type5_psatPss(final String id, final String name) {
		super(id, name);
		// _data is defined in the parent class. However init it here is a MUST
		_data = new Type5_psatPssData();
	}
	 ...
	 */
	public Type5_psatPssData getData() {
		return (Type5_psatPssData)_data;
	}
	...
	public void setDataXmlString(final String xmlString) {
		...
		_data = XmlUtil.toObject(xmlString, Type5_psatPssData.class);
	}
