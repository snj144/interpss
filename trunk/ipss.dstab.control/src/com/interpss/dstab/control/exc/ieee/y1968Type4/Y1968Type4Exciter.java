...
public class Y1968Type4Exciter extends AbstractExciter {
	...
	private static final NBY1968Type4ExciterEditPanel _editPanel = new NBY1968Type4ExciterEditPanel();
	
	/**
	 * Default Constructor
	 *
	 */
	public Y1968Type4Exciter() {
	 ...
	 */
	public Y1968Type4Exciter(final String id, final String name) {
		super(id, name);
		// _data is defined in the parent class. However we must be reference to an actual object
		_data = new Y1968Type4ExciterData();
	}
	 ...
	 */
	public Y1968Type4ExciterData getData() {
		return (Y1968Type4ExciterData)_data;
	}
	...
	public void setDataXmlString(final String xmlString) {
		...
		_data = XmlUtil.toObject(xmlString, Y1968Type4ExciterData.class);
	}
