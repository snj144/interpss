...
public class Type2_psatAvr extends AbstractExciter {
	...
	private static final NBType2_psatAvrEditPanel _editPanel = new NBType2_psatAvrEditPanel();
	
	/**
	 * Default Constructor
	 *
	 */
	public Type2_psatAvr() {
		this("excId", "PSAT_AVR_TYPE2"); 
	}
	 ...
	 */
	public Type2_psatAvrData getData() {
		return (Type2_psatAvrData)_data;
	}
	...
	public void setDataXmlString(final String xmlString) {
		...
		_data = XmlUtil.toObject(xmlString, Type2_psatAvrData.class);
	}
