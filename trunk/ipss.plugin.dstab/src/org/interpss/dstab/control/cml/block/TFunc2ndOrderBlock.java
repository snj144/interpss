	...
	public boolean initStateY0(double y0) {
		...
		if (k <= 0.0) {
			IpssLogger.getLogger().severe(
					"TFunc2ndOrderBlock.initState(), k <= 0.0");
			return false;
		} else if (b < 0.0) {
			IpssLogger.getLogger().severe(
					"TFunc2ndOrderBlock.initState() b < 0.0");
			return false;
		} else if (b == 0.0 && a != 0) {
			IpssLogger.getLogger().severe(
					"TFunc2ndOrderBlock.initState() b == 0.0 && a != 0");
			return false;
		} else if (limit != null && limit.isViolated(y0)) {
			IpssLogger.getLogger().severe(
					"TFunc2ndOrderBlock.initState() limit violation");
			return false;
		}
