...
public class V1_1_11_ORSC_CONT_Investigation extends UserTestSetup {
	@Test
	public void ca_test() throws Exception {
		...
		Contingency cont = model.getContingency("ORSC");
		cont.getMonitoringBranches().add(CoreObjectFactory.createMonitoringBranch(net, net.getBranch("Bus1765->Bus1778(1)")));
