 ...
 * </copyright>
 *
 * $Id: GenUnitOpCostCurveImpl.java,v 1.1 2007/03/02 14:01:11 mzhou Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.opencim.cim.iec61970.gen.production.impl.GenUnitOpCostCurveImpl#getNetGrossMWFlag <em>Net Gross MW Flag</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class GenUnitOpCostCurveImpl extends CurveScheduleImpl implements GenUnitOpCostCurve {
	/**
	...
	public void setNetGrossMWFlag(Boolean newNetGrossMWFlag) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProductionPackage.GEN_UNIT_OP_COST_CURVE__NET_GROSS_MW_FLAG, oldNetGrossMWFlag, netGrossMWFlag));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ProductionPackage.GEN_UNIT_OP_COST_CURVE__NET_GROSS_MW_FLAG:
