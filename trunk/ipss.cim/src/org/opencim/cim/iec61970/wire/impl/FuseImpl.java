 ...
 * </copyright>
 *
 * $Id: FuseImpl.java,v 1.1 2007/03/02 14:00:57 mzhou Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.opencim.cim.iec61970.wire.impl.FuseImpl#getAmpRating <em>Amp Rating</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FuseImpl extends SwitchImpl implements Fuse {
	...
	protected EClass eStaticClass() {
		return WirePackage.Literals.FUSE;
	}
	...
	public void setAmpRating(CurrentFlow newAmpRating) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WirePackage.FUSE__AMP_RATING, oldAmpRating, ampRating));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WirePackage.FUSE__AMP_RATING:
				return getAmpRating();
		}
