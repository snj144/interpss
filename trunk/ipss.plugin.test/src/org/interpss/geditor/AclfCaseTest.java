...
public class AclfCaseTest  extends PluginTestSetup {
	...
	public void AclfSimple2BusCapacitorCase() throws Exception {
		...
		AclfNetwork net = simuCtx.getAclfNet();
  		...
  		SwingBusAdapter swing = swingBus.toSwingBus();
		//System.out.println(ComplexFunc.toString(swing.getGenResults(UnitType.PU, net.getBaseKva())));
  		assertTrue(Math.abs(swing.getGenResults(Type.PU).getReal()-1.07225)<0.0001);
  		assertTrue(Math.abs(swing.getGenResults(Type.PU).getImaginary()- 0.54343)<0.0001);
	}
	...
	public void AclfSimple2BusConstILoadCase() throws Exception {
		...
		AclfNetwork net = simuCtx.getAclfNet();
  		...
  		SwingBusAdapter swing = swingBus.toSwingBus();
		//System.out.println(ComplexFunc.toString(swing.getGenResults(UnitType.PU, net.getBaseKva())));
  		assertTrue(Math.abs(swing.getGenResults(Type.PU).getReal()-0.95018)<0.0001);
  		assertTrue(Math.abs(swing.getGenResults(Type.PU).getImaginary()- 0.85852)<0.0001);
	}
	...
	public void AclfSimple2BusConstZLoadCase() throws Exception {
		...
		AclfNetwork net = simuCtx.getAclfNet();
  		...
  		SwingBusAdapter swing = swingBus.toSwingBus();
		//System.out.println(ComplexFunc.toString(swing.getGenResults(UnitType.PU, net.getBaseKva())));
  		assertTrue(Math.abs(swing.getGenResults(Type.PU).getReal()-0.84498)<0.0001);
  		assertTrue(Math.abs(swing.getGenResults(Type.PU).getImaginary()- 0.75283)<0.0001);
	}
	...
	public void AclfSimple2BusPsXfrCase() throws Exception {
		...
		AclfNetwork net = simuCtx.getAclfNet();
  		...
  		SwingBusAdapter swing = swingBus.toSwingBus();
		//System.out.println(ComplexFunc.toString(swing.getGenResults(UnitType.PU, net.getBaseKva())));
  		assertTrue(Math.abs(swing.getGenResults(Type.PU).getReal()-1.11526)<0.0001);
  		assertTrue(Math.abs(swing.getGenResults(Type.PU).getImaginary()- 1.03056)<0.0001);
	}
	...
	public void AclfSimple2BusPVLoadCase() throws Exception {
		...
		AclfNetwork net = simuCtx.getAclfNet();
  		...
  		SwingBusAdapter swing = swingBus.toSwingBus();
		//System.out.println(ComplexFunc.toString(swing.getGenResults(UnitType.PU, net.getBaseKva())));
  		assertTrue(Math.abs(swing.getGenResults(Type.PU).getReal()- 1.10463)<0.0001);
  		assertTrue(Math.abs(swing.getGenResults(Type.PU).getImaginary() + 0.93403)<0.0001);
	}
	...
	public void AclfSimple2BusXfrFromTurnRatioCase() throws Exception {
		...
		AclfNetwork net = simuCtx.getAclfNet();
  		...
  		SwingBusAdapter swing = swingBus.toSwingBus();
		//System.out.println(ComplexFunc.toString(swing.getGenResults(UnitType.PU, net.getBaseKva())));
  		assertTrue(Math.abs(swing.getGenResults(Type.PU).getReal()-1.13363)<0.0001);
  		assertTrue(Math.abs(swing.getGenResults(Type.PU).getImaginary()- 1.06727)<0.0001);
	}
	...
	public void AclfSimple2BusXfrToTurnRatioCase() throws Exception {
		...
		//System.out.println(ComplexFunc.toString(swing.getGenResults(UnitType.PU, net.getBaseKva())));
  		assertTrue(Math.abs(swing.getGenResults(Type.PU).getReal()-1.1153)<0.0001);
  		assertTrue(Math.abs(swing.getGenResults(Type.PU).getImaginary()- 1.0306)<0.0001);
	}
}
