...
public class NetworkImplTest {
  	...
  	@BeforeClass
  	public static void setUpEclipseResource() {
	 ...
	 */
	@Test
	public void getZoneintintTest() {
		Network net = createSimpleNet();
		assertTrue(net.getZone(1) != null);
	}

	@Test
	public void getNoBusTest() {
		Network net = createSimpleNet();
	 ...
	 */
	@Test
	public void getBranchStringTest() {
	 ...
	 */
	@Test
	public void getBranchStringStringTest() {
		Network net = NetRuleTest.buildTestNet();
	 ...
	 */
	@Test
	public void getBranchStringStringintTest() {
		Network net = NetRuleTest.buildTestNet();
		Branch bra1 = net.getBranch("Bus1", "Bus2", "1");
		assertTrue(bra1 != null);
	}
	 ...
	 */
	public void removeBranchStringStringintTest() {
	}

	/*
	 * tested in the NetRuleTest.java
	 */
	public void removeBranchBusBusintTest() {
	}
	 ...
	 */
	@Test
	public void buildSimpleNetTest() {
	  	Network net = NetRuleTest.buildTestNet(); 
