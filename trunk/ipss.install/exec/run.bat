...
java -classpath %LIB_PATH%;%BATIK_PATH%;%RPT_PATH%;%DB_PATH%;%SPRING_PATH%;%XML_PATH%;%CHART_PATH%;%IPSS_PATH%;%EMF_PATH%;%CUS_PATH% -Xms512m -Xmx1024m com.interpss.editor.GEditor