 ...
 *       &lt;sequence>
 *         &lt;element name="machId" type="{http://www.w3.org/2001/XMLSchema}string"/>
...
public class DStabSetPointChangeXmlType {
    ...
    @XmlElement(required = true)
    protected String valueChangeType;
     ...
     *     
     */
    public void setMachId(String value) {
        this.machId = value;
    }
     ...
     *     
     */
    public String getValueChangeType() {
     ...
     *     
     */
    public void setValueChangeType(String value) {
