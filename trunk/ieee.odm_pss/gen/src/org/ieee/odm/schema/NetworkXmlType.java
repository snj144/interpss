    ...
    extends IDRecordXmlType
{
    ...
    public static class BranchList {
        ...
        protected List<JAXBElement<BaseBranchXmlType>> branch;
         ...
         * 
         */
        public List<JAXBElement<BaseBranchXmlType>> getBranch() {
            if (branch == null) {
                branch = new ArrayList<JAXBElement<BaseBranchXmlType>>();
            }
            return this.branch;
        }
    ...
    public static class BusList {
        ...
        protected List<JAXBElement<BusXmlType>> bus;
         ...
         * 
         */
        public List<JAXBElement<BusXmlType>> getBus() {
            if (bus == null) {
                bus = new ArrayList<JAXBElement<BusXmlType>>();
            }
            return this.bus;
        }
