 ...
 *                 &lt;sequence>
 *                   &lt;element name="pvModel" type="{http://www.ieee.org/odm/Schema/2008}SolarPVModelXmlType" maxOccurs="unbounded"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
    ...
    extends BusXmlType
{
    ...
    protected DcBusXmlType.PvModelList pvModelList;
     ...
     * @return
     *     possible object is
     *     {@link DcBusXmlType.PvModelList }
     *     
     */
    public DcBusXmlType.PvModelList getPvModelList() {
        return pvModelList;
    }
     ...
     *     
     */
    public void setPvModelList(DcBusXmlType.PvModelList value) {
    ...
    public static class PvModelList {
        ...
        protected List<SolarPVModelXmlType> pvModel;
         ...
         * 
         */
        public List<SolarPVModelXmlType> getPvModel() {
            if (pvModel == null) {
                pvModel = new ArrayList<SolarPVModelXmlType>();
            }
            return this.pvModel;
        }
