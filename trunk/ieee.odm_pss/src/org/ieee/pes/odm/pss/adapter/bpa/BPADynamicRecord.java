...
public class BPADynamicRecord {	
	...
	final static int turbin_governorData=6;
	...
	public static int getDataType(String str){		 
		 if (str.startsWith("CASE")||str.startsWith("SOL")){
				...
				dataType=faultOperation;
					...
					str.substring(0, 2).equals("MF")||str.substring(0, 2).equals("MC")){
				dataType=generatorData;
			}else if (str.substring(0, 2).trim().equals("Fk")||
					str.substring(0, 2).equals("FQ")||str.substring(0, 2).equals("FV")
					||str.substring(0, 2).trim().equals("FJ")||str.substring(0, 2).equals("EK")||
					str.substring(0, 2).equals("EA")||str.substring(0, 2).equals("EC")){
				dataType=exciterData;
			}else if(str.substring(0, 2).trim().equals("SS")||
					str.substring(0, 2).equals("SP")||str.substring(0, 2).equals("SG")
					||str.substring(0, 2).equals("SI")||str.substring(0, 3).equals("SI+")){
				dataType=pssData;
			}else if(str.substring(0, 2).trim().equals("GS")||
					str.substring(0, 2).equals("TA")||str.substring(0, 2).equals("TB")
					||str.substring(0, 2).equals("GH")||str.substring(0, 2).equals("GG")){
				dataType=turbin_governorData;
			}else if(str.substring(0, 2).trim().equals("LA")||
					str.substring(0, 2).equals("LB")||str.substring(0, 2).equals("MI")){
				dataType=loadData;				
    ...
    public static void processGeneratorData(){
    	System.out.println("generator");
    }
    public static void processExciterData(){
