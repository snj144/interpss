...
public class PSSEV26_ODMTest { 
	...
	public void testCase1() throws Exception {
        ...
        */
		...
		assertTrue(bus.getLoadflowData().getShuntQData().getEquivQ().getValue() == 75.0);
 ...
 */
      ...
      <branch circuitId="' 1'" id="No31212_to_No31210_cirId_' 1'" offLine="false">
		 ...
		 */
		BranchRecordXmlType branch = ParserHelper.findBranchRecord("Bus31212", "Bus31210", "_1", net);
      ...
      <branch circuitId="' 1'" id="No31212_to_No31435_cirId_' 1'" offLine="false">
		 ...
		 */
		branch = ParserHelper.findBranchRecord("Bus31212", "Bus31435", "_1", net);
