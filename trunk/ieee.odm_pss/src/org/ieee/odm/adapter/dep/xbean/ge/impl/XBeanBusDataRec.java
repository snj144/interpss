...
public class XBeanBusDataRec extends XBeanBusHeaderRec {
			public int ty, owner;
			public double vs_pu, vt_pu, an_deg, vma, vmi;
			public int level, stisol, islnum;
			public double latitude, longitude;

	public XBeanBusDataRec(String lineStr, XBeanGE_PSLF_Adapter.VersionNo version, final XBeanODMModelParser parser, Logger logger) {
/*
