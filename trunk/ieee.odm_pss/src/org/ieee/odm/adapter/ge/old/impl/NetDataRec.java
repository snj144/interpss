...
package org.ieee.odm.adapter.ge.old.impl;

import java.util.StringTokenizer;

import org.ieee.odm.adapter.ge.old.GE_PSLF_AdapterOld;
...
public class NetDataRec {
	static public class TitleRec {
		public void processLineStr(String lineStr, GE_PSLF_AdapterOld.VersionNo version, JaxbODMModelParser parser) {
	...
	static public class AreaRec {
		...
		public AreaRec(String lineStr, GE_PSLF_AdapterOld.VersionNo version, JaxbODMModelParser parser) throws Exception {
			LoadflowNetXmlType baseCaseNet = parser.getAclfBaseCase();
	...
	static public class ZoneRec {
		...
		public ZoneRec(String lineStr, GE_PSLF_AdapterOld.VersionNo version, JaxbODMModelParser parser) throws Exception {
			LoadflowNetXmlType baseCaseNet = parser.getAclfBaseCase();
	...
	static public class OwnerRec {
		...
		public OwnerRec(String lineStr, GE_PSLF_AdapterOld.VersionNo version) {
 ...
 */	
	static public class InterfaceRec {
		...
		public InterfaceRec(String lineStr, GE_PSLF_AdapterOld.VersionNo version) {
...
*/	
	static public class InterfaceBranchRec extends BranchHeaderRec{
		...
		public InterfaceBranchRec(String lineStr, GE_PSLF_AdapterOld.VersionNo version) {
