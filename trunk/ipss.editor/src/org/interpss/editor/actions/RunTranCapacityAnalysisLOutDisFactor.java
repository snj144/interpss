...
public class RunTranCapacityAnalysisLOutDisFactor extends IpssAbstractActionDefault {
	...
	public void actionPerformed(ActionEvent e) {
		RunUtilFunc.performRunAction(getCurrentDocument(), EditorActionAdapter.RunType.LineOutageDistFactor, graphpad);
	}
