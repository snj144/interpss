...
public class XmlScriptRunWorker {
	...
	private static boolean runAclf(IpssXmlParser parser,
	...
	private static boolean runAcsc(IpssXmlParser parser,
	...
	private static boolean runDStab(IpssXmlParser parser, SimuContext simuCtx,
			IPSSMsgHub msg) {
