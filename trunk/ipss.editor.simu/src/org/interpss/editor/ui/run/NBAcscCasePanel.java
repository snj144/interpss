...
//	private AcscCaseData _caseData = null;
    ...
    private AcscFaultAnalysisXmlType xmlCaseData;
	...
	*/
	public boolean setForm2Editor() {
        ...
        if (xmlCaseData.getPreFaultBusVoltage() == PreFaultBusVoltageEnumType.UNIT_VOLT) {
	...
	*/
    ...
    private void loadflowVoltRadioButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loadflowVoltRadioButtonActionPerformed
		if (_appCtx.isLfConverged()) {
			...
			EditorPluginSpringFactory.getEditorDialogUtil().showMsgDialog(parentDialog, "Warning", 
