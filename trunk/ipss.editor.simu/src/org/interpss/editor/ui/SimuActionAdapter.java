...
public class SimuActionAdapter {
	public static void menu_annotate_loadflow(JGraph graph) {
		if (graph != null) {
			try {
				SimuContext simuCtx = (SimuContext)GraphSpringFactory.getIpssGraphicEditor().getCurrentAppSimuContext().getSimuCtx();
	...
	public static void menu_tools_debug_projDataInfo(IAppSimuContext appSimuContext) {
		...
		XmlBeanUtil.ToolKid = XmlBeanUtil.TOOL_CASTOR;
  		IOutputTextDialog dialog = UISpringFactory.getOutputTextDialog("Project data");
  		dialog.display(str);		
	}
	...
	public static void menu_tools_debug_netDataInfo(IGFormContainer gFormContainer) {
		...
		XmlBeanUtil.ToolKid = XmlBeanUtil.TOOL_CASTOR;
  		IOutputTextDialog dialog = UISpringFactory.getOutputTextDialog("Network data");
  		dialog.display(str);		
	}
	...
	public static void menu_tools_debug_simuCtxInfo() {
		String str = "";
		try {
			IAppSimuContext project = GraphSpringFactory.getIpssGraphicEditor().getCurrentAppSimuContext();
  		...
  		IOutputTextDialog dialog = UISpringFactory.getOutputTextDialog("SimuNetwork object info");
  		dialog.display(str);		
	}
}
