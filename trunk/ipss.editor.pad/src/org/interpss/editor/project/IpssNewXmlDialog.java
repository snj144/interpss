...
public class IpssNewXmlDialog extends javax.swing.JDialog {
	...
	protected void initGuiComponents() {
		...
		newRadioButton.setText("Create a New XML File");
		...
		fromRadioButton.setText("Import a XML File from existing source");
	...
	public void updateState() {
		...
		try {
			...
			showError("Create xml error:" + e.getMessage());
			return;
		}
	...
	public void selectFile() {
		try {
			...
			if (in != null) {
				...
				if (getFile() == null) {
					showError("Can't open the selected xml file.");
					return;
				}
			}
		} catch (Exception ex) {
