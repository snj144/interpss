...
public class GPGraph extends JGraph {
     ...
     * public overridable
     * 
     * @see org.interpss.editor.coreframework.GPGraphpad#createGraphInstance() method. Finally setters
...
//		if (value instanceof BusCell ||	value instanceof JGraphBusView ) {
//			return null;
//		}
//		else if (value instanceof BranchEdge) {
//			return null;
//		}
//        else if (value instanceof JGraphBranchEdgeView) {
//            return ((JGraphBranchEdgeView) value).getBranchForm().getLabel(IUserData.BRANCH_LABEL);
//        }
//		else if (value instanceof LabelCell && !(value instanceof AnnotateLabelCell)) {
//			return ((IUserData)((LabelCell)value).getUserObject()).getLabel(IUserData.BUS_LABEL);
//		}
//		else if (value instanceof JGraphLabelView && !(value instanceof JGraphAnnotateLabelView)) {
//			LabelCell cell = (LabelCell)((JGraphLabelView)value).getCell();
//			return ((IUserData)(cell.getUserObject())).getLabel(IUserData.BUS_LABEL);
//		}
//		// added by Mike 12/22/05
//		/*
//		 * Get bus annotate label
//		 */
//		else if (value instanceof JGraphAnnotateLabelView) {
//			AnnotateLabelCell cell = (AnnotateLabelCell)((JGraphAnnotateLabelView)value).getCell();
//			return ((IUserData)(cell.getUserObject())).getLabel(IUserData.BUS_ANNOTATE_LABEL);
//		}
//		else if (value instanceof AnnotateLabelCell) {
//			return ((IUserData)((AnnotateLabelCell)value).getUserObject()).getLabel(IUserData.BUS_ANNOTATE_LABEL);
//		}
