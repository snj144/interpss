...
public class IpssNewReportDialog extends javax.swing.JDialog {
	...
	public IpssNewReportDialog(GPGraphpad graphpad, String title) {
		...
		super(graphpad.getFrame(), "New Report File", true);
	...
	protected void initGuiComponents() {
		...
		newRadioButton.setText("Create a New Report");
		...
		fromRadioButton.setText("Import a Report from existing source");
	...
	public void updateState() {
		...
		try {
			...
			showError("Create report error:" + e.getMessage());
			return;
		}
	...
	public void selectFile() {
		try {
			...
			if (in != null) {
				setFile(com.interpss.editor.util.Utilities.OpenReportFile(
						graphpad, in.getName()));
				this.setSrcFileName(in.getName());
				dirTextField.setText(in.getName());
				if (getFile() == null) {
					showError("Can't open the selected report.");
					return;
				}
			}
		} catch (Exception ex) {
