...
/**
 * The interface the GPGraphpad framework uses to handle the objects you put inside graph cells.
 * If you want GPGraphpad to handle your custom business objects,
...
public interface ICellBuisnessObject extends Serializable, Cloneable {
	...
	public abstract void showPropertyDialog(JGraph graph,
			final Object cell);
