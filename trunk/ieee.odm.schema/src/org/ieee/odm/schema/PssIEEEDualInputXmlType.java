    ...
    extends StabilizerModelXmlType
{
    ...
    @XmlElement(name = "Trw", namespace = "http://www.ieee.org/odm/Schema/2008", required = true)
    ...
    @XmlElement(name = "T7", namespace = "http://www.ieee.org/odm/Schema/2008", required = true)
    protected TimePeriodXmlType t7;
    @XmlElement(name = "Kr", namespace = "http://www.ieee.org/odm/Schema/2008")
    protected double kr;
    @XmlElement(name = "Trp", namespace = "http://www.ieee.org/odm/Schema/2008", required = true)
    protected TimePeriodXmlType trp;
    @XmlElement(name = "TW", namespace = "http://www.ieee.org/odm/Schema/2008", required = true)
    protected TimePeriodXmlType tw;
    @XmlElement(name = "TW1", namespace = "http://www.ieee.org/odm/Schema/2008", required = true)
    protected TimePeriodXmlType tw1;
    @XmlElement(name = "TW2", namespace = "http://www.ieee.org/odm/Schema/2008", required = true)
    protected TimePeriodXmlType tw2;
    @XmlElement(name = "KS", namespace = "http://www.ieee.org/odm/Schema/2008")
    protected double ks;
    @XmlElement(name = "T9", namespace = "http://www.ieee.org/odm/Schema/2008", required = true)
    protected TimePeriodXmlType t9;
    @XmlElement(name = "T10", namespace = "http://www.ieee.org/odm/Schema/2008", required = true)
    protected TimePeriodXmlType t10;
    @XmlElement(name = "T12", namespace = "http://www.ieee.org/odm/Schema/2008", required = true)
    protected TimePeriodXmlType t12;
    @XmlElement(name = "Kp", namespace = "http://www.ieee.org/odm/Schema/2008")
    protected double kp;
    ...
    @XmlElement(name = "T13", namespace = "http://www.ieee.org/odm/Schema/2008", required = true)
    protected TimePeriodXmlType t13;
    @XmlElement(name = "T14", namespace = "http://www.ieee.org/odm/Schema/2008", required = true)
    ...
    @XmlElement(name = "VSMAX", namespace = "http://www.ieee.org/odm/Schema/2008")
    protected double vsmax;
    @XmlElement(name = "VSMIN", namespace = "http://www.ieee.org/odm/Schema/2008")
