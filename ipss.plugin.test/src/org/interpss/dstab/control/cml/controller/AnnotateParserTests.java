...
public class AnnotateParserTests {
	...
	public void exciterTestCase() {
		...
		try {
			...
			assertTrue(exc.initStates(mach.getDStabBus(), mach, null));
	...
	public void governorTestCase() {
		...
		try {
			...
			*/
			...
			assertTrue(gov.initStates(mach.getDStabBus(), mach, null));
	...
	public void stabilizerTestCase() {
		...
		try {
			...
			*/
			...
			assertTrue(pss.initStates(mach.getDStabBus(), mach, null));
