...
//  		_zPanel.setScPointTableModelListener();
    ...
    private void initComponents() {
        ...
        busTypeSelectPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(null, bundle.getString("NBDistBusEditPanel.busTypeSelectPanel.border.title"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 10))); // NOI18N

        busTypeButtonGroup.add(utilityRadioButton);
        utilityRadioButton.setFont(new java.awt.Font("Dialog", 0, 10));
        utilityRadioButton.setText(bundle.getString("NBDistBusEditPanel.utilityRadioButton.text")); // NOI18N
        ...
        generatorRadioButton.setText(bundle.getString("NBDistBusEditPanel.generatorRadioButton.text")); // NOI18N
        ...
        synMotorRadioButton.setText(bundle.getString("NBDistBusEditPanel.synMotorRadioButton.text")); // NOI18N
        ...
        indMotorRadioButton.setText(bundle.getString("NBDistBusEditPanel.indMotorRadioButton.text")); // NOI18N
        ...
        mixedLoadRadioButton.setText(bundle.getString("NBDistBusEditPanel.mixedLoadRadioButton.text")); // NOI18N
        ...
        nonContributeRadioButton.setText(bundle.getString("NBDistBusEditPanel.nonContributeRadioButton.text")); // NOI18N
