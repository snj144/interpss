...
public class NBAclfTransBusEditPanel extends javax.swing.JPanel implements IFormDataPanel {
    ...
    private void initComponents() {
        ...
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("org/interpss/editor/ui/edit/trans/bus/Bundle"); // NOI18N
        genTypePanel.setBorder(javax.swing.BorderFactory.createTitledBorder(null, bundle.getString("NBAclfTransBusEditPanel.genTypePanel.border.title"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 10))); // NOI18N
        ...
        swingRadioButton.setText(bundle.getString("NBAclfTransBusEditPanel.swingRadioButton.text")); // NOI18N
        ...
        pvRadioButton.setText(bundle.getString("NBAclfTransBusEditPanel.pvRadioButton.text")); // NOI18N
        ...
        pqRadioButton.setSelected(true);
        pqRadioButton.setText(bundle.getString("NBAclfTransBusEditPanel.pqRadioButton.text")); // NOI18N
        ...
        remoteQRadioButton.setText(bundle.getString("NBAclfTransBusEditPanel.remoteQRadioButton.text")); // NOI18N
        remoteQRadioButton.setToolTipText(bundle.getString("NBAclfTransBusEditPanel.remoteQRadioButton.toolTipText")); // NOI18N
        remoteQRadioButton.setEnabled(false);
        ...
        capRadioButton.setText(bundle.getString("NBAclfTransBusEditPanel.capRadioButton.text")); // NOI18N
        ...
        nonGenRadioButton.setText(bundle.getString("NBAclfTransBusEditPanel.nonGenRadioButton.text")); // NOI18N
        ...
        scriptGenRadioButton.setText(bundle.getString("NBAclfTransBusEditPanel.scriptGenRadioButton.text")); // NOI18N
        ...
        pGenLabel.setText(bundle.getString("NBAclfTransBusEditPanel.pGenLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        pGenTextField.setText(bundle.getString("NBAclfTransBusEditPanel.pGenTextField.text")); // NOI18N
        ...
        qGenLabel.setText(bundle.getString("NBAclfTransBusEditPanel.qGenLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridy = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        ...
        qGenTextField.setText(bundle.getString("NBAclfTransBusEditPanel.qGenTextField.text")); // NOI18N
        ...
        adjustCheckBox.setText(bundle.getString("NBAclfTransBusEditPanel.adjustCheckBox.text")); // NOI18N
        adjustCheckBox.setEnabled(false);
        ...
        reControl1Label.setText(bundle.getString("NBAclfTransBusEditPanel.reControl1Label.text")); // NOI18N
        ...
        voltageRadioButton.setText(bundle.getString("NBAclfTransBusEditPanel.voltageRadioButton.text")); // NOI18N
        ...
        mvaFlowRadioButton.setText(bundle.getString("NBAclfTransBusEditPanel.mvaFlowRadioButton.text")); // NOI18N
        ...
        reQControl2Label.setText(bundle.getString("NBAclfTransBusEditPanel.reQControl2Label.text")); // NOI18N
        ...
        maxLabel.setText(bundle.getString("NBAclfTransBusEditPanel.maxLabel.text")); // NOI18N
        ...
        maxTextField.setText(bundle.getString("NBAclfTransBusEditPanel.maxTextField.text")); // NOI18N
        ...
        minLabel.setText(bundle.getString("NBAclfTransBusEditPanel.minLabel.text")); // NOI18N
        ...
        minTextField.setText(bundle.getString("NBAclfTransBusEditPanel.minTextField.text")); // NOI18N
        ...
        remoteBusLabel.setText(bundle.getString("NBAclfTransBusEditPanel.remoteBusLabel.text")); // NOI18N
        remoteBusLabel.setEnabled(false);
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        remoteBusComboBox.setToolTipText(bundle.getString("NBAclfTransBusEditPanel.remoteBusComboBox.toolTipText")); // NOI18N
        remoteBusComboBox.setEnabled(false);
        ...
        flowDirectionPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(null, bundle.getString("NBAclfTransBusEditPanel.flowDirectionPanel.border.title"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 10))); // NOI18N
        ...
        from2ToRadioButton.setText(bundle.getString("NBAclfTransBusEditPanel.from2ToRadioButton.text")); // NOI18N
        ...
        to2FromRadioButton.setText(bundle.getString("NBAclfTransBusEditPanel.to2FromRadioButton.text")); // NOI18N
        ...
        mvarSodePanel.setBorder(javax.swing.BorderFactory.createTitledBorder(null, bundle.getString("NBAclfTransBusEditPanel.mvarSodePanel.border.title"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 10))); // NOI18N
        ...
        mvarOnFromSideRadioButton.setText(bundle.getString("NBAclfTransBusEditPanel.mvarOnFromSideRadioButton.text")); // NOI18N
        ...
        mvarOnToSideRadioButton.setText(bundle.getString("NBAclfTransBusEditPanel.mvarOnToSideRadioButton.text")); // NOI18N
        ...
        loadTypePanel.setBorder(javax.swing.BorderFactory.createTitledBorder(null, bundle.getString("NBAclfTransBusEditPanel.loadTypePanel.border.title"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 10))); // NOI18N
        ...
        constPRadioButton.setSelected(true);
        constPRadioButton.setText(bundle.getString("NBAclfTransBusEditPanel.constPRadioButton.text")); // NOI18N
        ...
        constIRadioButton.setText(bundle.getString("NBAclfTransBusEditPanel.constIRadioButton.text")); // NOI18N
        ...
        constZRadioButton.setText(bundle.getString("NBAclfTransBusEditPanel.constZRadioButton.text")); // NOI18N
        ...
        funcLoadRadioButton.setText(bundle.getString("NBAclfTransBusEditPanel.funcLoadRadioButton.text")); // NOI18N
        funcLoadRadioButton.setEnabled(false);
        ...
        nonLoadRadioButton.setText(bundle.getString("NBAclfTransBusEditPanel.nonLoadRadioButton.text")); // NOI18N
        ...
        scriptLoadRadioButton.setText(bundle.getString("NBAclfTransBusEditPanel.scriptLoadRadioButton.text")); // NOI18N
        ...
        pLoadLabel.setText(bundle.getString("NBAclfTransBusEditPanel.pLoadLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        ...
        pLoadTextField.setText(bundle.getString("NBAclfTransBusEditPanel.pLoadTextField.text")); // NOI18N
        ...
        qLoadLabel.setText(bundle.getString("NBAclfTransBusEditPanel.qLoadLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        ...
        qLoadTextField.setText(bundle.getString("NBAclfTransBusEditPanel.qLoadTextField.text")); // NOI18N
        ...
        constP_PLabel.setText(bundle.getString("NBAclfTransBusEditPanel.constP_PLabel.text")); // NOI18N
        ...
        constP_PTextField.setText(bundle.getString("NBAclfTransBusEditPanel.constP_PTextField.text")); // NOI18N
        ...
        constP_QLabel.setText(bundle.getString("NBAclfTransBusEditPanel.constP_QLabel.text")); // NOI18N
        ...
        constP_QTextField.setText(bundle.getString("NBAclfTransBusEditPanel.constP_QTextField.text")); // NOI18N
        ...
        constI_PLabel.setText(bundle.getString("NBAclfTransBusEditPanel.constI_PLabel.text")); // NOI18N
        ...
        constI_PTextField.setText(bundle.getString("NBAclfTransBusEditPanel.constI_PTextField.text")); // NOI18N
        ...
        constI_QLabel.setText(bundle.getString("NBAclfTransBusEditPanel.constI_QLabel.text")); // NOI18N
        ...
        constI_QTextField.setText(bundle.getString("NBAclfTransBusEditPanel.constI_QTextField.text")); // NOI18N
        ...
        constZ_PLabel.setText(bundle.getString("NBAclfTransBusEditPanel.constZ_PLabel.text")); // NOI18N
        ...
        constZ_PTextField.setText(bundle.getString("NBAclfTransBusEditPanel.constZ_PTextField.text")); // NOI18N
        ...
        constZ_QLabel.setText(bundle.getString("NBAclfTransBusEditPanel.constZ_QLabel.text")); // NOI18N
        ...
        constZ_QTextField.setText(bundle.getString("NBAclfTransBusEditPanel.constZ_QTextField.text")); // NOI18N
        ...
        shutYLabel.setText(bundle.getString("NBAclfTransBusEditPanel.shutYLabel.text")); // NOI18N
        shuntYPanel.add(shutYLabel);

        shuntGTextField.setColumns(8);
        shuntGTextField.setFont(new java.awt.Font("Dialog", 0, 12));
        shuntGTextField.setText(bundle.getString("NBAclfTransBusEditPanel.shuntGTextField.text")); // NOI18N
        ...
        shuntBTextField.setText(bundle.getString("NBAclfTransBusEditPanel.shuntBTextField.text")); // NOI18N
        ...
        busTabbedPane.addTab(bundle.getString("NBAclfTransBusEditPanel.lfDataPanel.TabConstraints.tabTitle"), lfDataPanel); // NOI18N
        busTabbedPane.addTab(bundle.getString("NBAclfTransBusEditPanel.scriptPanel.TabConstraints.tabTitle"), scriptPanel); // NOI18N
