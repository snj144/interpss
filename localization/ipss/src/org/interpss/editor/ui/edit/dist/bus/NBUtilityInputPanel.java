...
public class NBUtilityInputPanel extends javax.swing.JPanel  implements IFormDataPanel {
    ...
    private void initComponents() {
        ...
        voltageLabel.setText(bundle.getString("NBUtilityInputPanel.voltageLabel.text")); // NOI18N
        ...
        voltageTextField.setText(bundle.getString("NBUtilityInputPanel.voltageTextField.text")); // NOI18N
        voltageTextField.setName("voltageTextField"); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        vUnitComboBox.setName("vUnitComboBox"); // NOI18N
        add(vUnitComboBox, new java.awt.GridBagConstraints());

        angleLabel.setFont(new java.awt.Font("Dialog", 0, 12));
        angleLabel.setText(bundle.getString("NBUtilityInputPanel.angleLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(0, 0, 0, 5);
        ...
        angleTextField.setText(bundle.getString("NBUtilityInputPanel.angleTextField.text")); // NOI18N
        angleTextField.setName("angleTextField"); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        add(angleTextField, gridBagConstraints);

        angleUnitLabel.setFont(new java.awt.Font("Dialog", 0, 12));
        angleUnitLabel.setText(bundle.getString("NBUtilityInputPanel.angleUnitLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        add(angleUnitLabel, gridBagConstraints);

        mva3PLabel.setFont(new java.awt.Font("Dialog", 0, 12));
        mva3PLabel.setText(bundle.getString("NBUtilityInputPanel.mva3PLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        mva3PField.setText(bundle.getString("NBUtilityInputPanel.mva3PField.text")); // NOI18N
        mva3PField.setName("mva3PTextField"); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridy = 1;
        add(mva3PField, gridBagConstraints);

        mva1PLabel.setFont(new java.awt.Font("Dialog", 0, 12));
        mva1PLabel.setText(bundle.getString("NBUtilityInputPanel.mva1PLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        mva1PField.setText(bundle.getString("NBUtilityInputPanel.mva1PField.text")); // NOI18N
        mva1PField.setName("mva1PTextField"); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridy = 1;
        ...
        mvaUnitComboBox.setName("mvaUnitComboBox"); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridy = 1;
        ...
        x_r3PLabel3.setText(bundle.getString("NBUtilityInputPanel.x_r3PLabel3.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        x_r3PField.setText(bundle.getString("NBUtilityInputPanel.x_r3PField.text")); // NOI18N
        x_r3PField.setName("x_r3PTextField"); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridy = 2;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(5, 0, 5, 0);
        ...
        x_r1PLabel.setText(bundle.getString("NBUtilityInputPanel.x_r1PLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridy = 2;
        gridBagConstraints.gridwidth = 2;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        ...
        x_r1PTextField.setText(bundle.getString("NBUtilityInputPanel.x_r1PTextField.text")); // NOI18N
        x_r1PTextField.setName("x_r1PTextField"); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridy = 2;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
