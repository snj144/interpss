...
public class NBBranchEditDialog extends javax.swing.JDialog  implements IFormDataDialog {
	...
	*/
    ...
    private void initComponents() {
        ...
        branchNumberLabel.setText(bundle.getString("NBBranchEditDialog.branchNumberLabel.text")); // NOI18N
        idPanel.add(branchNumberLabel);

        fromNameLabel.setFont(new java.awt.Font("Dialog", 0, 10));
        fromNameLabel.setText(bundle.getString("NBBranchEditDialog.fromNameLabel.text")); // NOI18N
        ...
        toNameLabel.setText(bundle.getString("NBBranchEditDialog.toNameLabel.text")); // NOI18N
        ...
        branchNameLabel.setText(bundle.getString("NBBranchEditDialog.branchNameLabel.text")); // NOI18N
        ...
        areaLabel.setText(bundle.getString("NBBranchEditDialog.areaLabel.text")); // NOI18N
        idPanel.add(areaLabel);

        areaField.setColumns(2);
        areaField.setFont(new java.awt.Font("Dialog", 0, 10));
        areaField.setText(bundle.getString("NBBranchEditDialog.areaField.text")); // NOI18N
        areaField.setName("areaTextField"); // NOI18N
        idPanel.add(areaField);

        zoneLabel.setFont(new java.awt.Font("Dialog", 0, 10));
        zoneLabel.setText(bundle.getString("NBBranchEditDialog.zoneLabel.text")); // NOI18N
        idPanel.add(zoneLabel);

        zoneField.setColumns(2);
        zoneField.setFont(new java.awt.Font("Dialog", 0, 10));
        zoneField.setText(bundle.getString("NBBranchEditDialog.zoneField.text")); // NOI18N
        ...
        inServiceCheckBox.setText(bundle.getString("NBBranchEditDialog.inServiceCheckBox.text")); // NOI18N
        ...
        saveButton.setText(bundle.getString("NBBranchEditDialog.saveButton.text")); // NOI18N
        ...
        cancelButton.setText(bundle.getString("NBBranchEditDialog.cancelButton.text")); // NOI18N
    ...
    private void saveActionHandler(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionHandler
		...
		try {
        	if (!saveEditor2Form(errMsg)) {
        		CoreCommonSpringCtx.getEditorDialogUtil().showMsgDialog(this, "Branch Input Data Error", errMsg);
				return;
        	}
        } catch (Exception e) {
      		IpssLogger.logErr(e);
      		CoreCommonSpringCtx.getEditorDialogUtil().showMsgDialog(this, "Branch Input Data Error", e.toString());
			return;
        }	
