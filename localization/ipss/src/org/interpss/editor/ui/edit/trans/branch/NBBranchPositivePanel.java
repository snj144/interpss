...
public class NBBranchPositivePanel extends javax.swing.JPanel implements IFormDataPanel {
    ...
    private void initComponents() {
        ...
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("org/interpss/editor/ui/edit/trans/branch/Bundle"); // NOI18N
        branchTypePanel.setBorder(javax.swing.BorderFactory.createTitledBorder(null, bundle.getString("NBBranchPositivePanel.branchTypePanel.border.title"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 10))); // NOI18N
        ...
        lineRadioButton.setSelected(true);
        lineRadioButton.setText(bundle.getString("NBBranchPositivePanel.lineRadioButton.text")); // NOI18N
        ...
        xfrRadioButton.setText(bundle.getString("NBBranchPositivePanel.xfrRadioButton.text")); // NOI18N
        ...
        psXfrRadioButton.setText(bundle.getString("NBBranchPositivePanel.psXfrRadioButton.text")); // NOI18N
        ...
        branchScriptRadioButton.setText(bundle.getString("NBBranchPositivePanel.branchScriptRadioButton.text")); // NOI18N
        ...
        rLabel.setText(bundle.getString("NBBranchPositivePanel.rLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        ...
        rTextField.setText(bundle.getString("NBBranchPositivePanel.rTextField.text")); // NOI18N
        ...
        xLabel.setText(bundle.getString("NBBranchPositivePanel.xLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        xTextField.setText(bundle.getString("NBBranchPositivePanel.xTextField.text")); // NOI18N
        ...
        hBLabel.setText(bundle.getString("NBBranchPositivePanel.hBLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        hBTextField.setText(bundle.getString("NBBranchPositivePanel.hBTextField.text")); // NOI18N
        ...
        fromTapLabel.setText(bundle.getString("NBBranchPositivePanel.fromTapLabel.text")); // NOI18N
        ...
        fromTapTextField.setText(bundle.getString("NBBranchPositivePanel.fromTapTextField.text")); // NOI18N
        fromTapTextField.setToolTipText(bundle.getString("NBBranchPositivePanel.fromTapTextField.toolTipText")); // NOI18N
        ...
        toTapLabel.setText(bundle.getString("NBBranchPositivePanel.toTapLabel.text")); // NOI18N
        ...
        toTapTextField.setText(bundle.getString("NBBranchPositivePanel.toTapTextField.text")); // NOI18N
        toTapTextField.setToolTipText(bundle.getString("NBBranchPositivePanel.toTapTextField.toolTipText")); // NOI18N
        ...
        mvaRating1Label.setText(bundle.getString("NBBranchPositivePanel.mvaRating1Label.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        mvaRating1TextField.setText(bundle.getString("NBBranchPositivePanel.mvaRating1TextField.text")); // NOI18N
        ...
        mvaRating2Label.setText(bundle.getString("NBBranchPositivePanel.mvaRating2Label.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridy = 3;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        mvaRating2TextField.setText(bundle.getString("NBBranchPositivePanel.mvaRating2TextField.text")); // NOI18N
        ...
        mvaRating3Label.setText(bundle.getString("NBBranchPositivePanel.mvaRating3Label.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridy = 3;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(5, 20, 10, 0);
        ...
        mvaRating3TextField.setText(bundle.getString("NBBranchPositivePanel.mvaRating3TextField.text")); // NOI18N
        ...
        branchShuntYLabel.setText(bundle.getString("NBBranchPositivePanel.branchShuntYLabel.text")); // NOI18N
        ...
        fromShuntGTextField.setText(bundle.getString("NBBranchPositivePanel.fromShuntGTextField.text")); // NOI18N
        ...
        fromShuntBTextField.setText(bundle.getString("NBBranchPositivePanel.fromShuntBTextField.text")); // NOI18N
        fromShuntBTextField.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                fromShuntBTextFieldActionPerformed(evt);
            }
        });
        branchShuntYPanel.add(fromShuntBTextField);

        toShuntYLabel.setFont(new java.awt.Font("Dialog", 0, 12));
        toShuntYLabel.setText(bundle.getString("NBBranchPositivePanel.toShuntYLabel.text")); // NOI18N
        branchShuntYPanel.add(toShuntYLabel);

        toShuntGTextField.setColumns(4);
        toShuntGTextField.setFont(new java.awt.Font("Dialog", 0, 12));
        toShuntGTextField.setText(bundle.getString("NBBranchPositivePanel.toShuntGTextField.text")); // NOI18N
        toShuntGTextField.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                toShuntGTextFieldActionPerformed(evt);
            }
        });
        ...
        toShuntBTextField.setText(bundle.getString("NBBranchPositivePanel.toShuntBTextField.text")); // NOI18N
        ...
        psXfrPowerCheckBox.setText(bundle.getString("NBBranchPositivePanel.psXfrPowerCheckBox.text")); // NOI18N
        ...
        pSepcLabel.setText(bundle.getString("NBBranchPositivePanel.pSepcLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        pSpecTextField.setText(bundle.getString("NBBranchPositivePanel.pSpecTextField.text")); // NOI18N
        ...
        pControlSidePanel.setBorder(javax.swing.BorderFactory.createTitledBorder(null, bundle.getString("NBBranchPositivePanel.pControlSidePanel.border.title"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 10))); // NOI18N

        pControlSideButtonGroup.add(pControlFromSideRadioButton);
        pControlFromSideRadioButton.setFont(new java.awt.Font("Dialog", 0, 12));
        pControlFromSideRadioButton.setSelected(true);
        pControlFromSideRadioButton.setText(bundle.getString("NBBranchPositivePanel.pControlFromSideRadioButton.text")); // NOI18N
        ...
        pControlToSideRadioButton.setText(bundle.getString("NBBranchPositivePanel.pControlToSideRadioButton.text")); // NOI18N
        ...
        angleMaxLabel.setText(bundle.getString("NBBranchPositivePanel.angleMaxLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 2;
        ...
        angleMaxTextField.setText(bundle.getString("NBBranchPositivePanel.angleMaxTextField.text")); // NOI18N
        ...
        angleMinLabel.setText(bundle.getString("NBBranchPositivePanel.angleMinLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridy = 3;
        gridBagConstraints.insets = new java.awt.Insets(0, 0, 20, 0);
        ...
        angleMinTextField.setText(bundle.getString("NBBranchPositivePanel.angleMinTextField.text")); // NOI18N
        ...
        flowDirectionPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(null, bundle.getString("NBBranchPositivePanel.flowDirectionPanel.border.title"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 10))); // NOI18N

        flowDirectionButtonGroup.add(from2ToRadioButton);
        from2ToRadioButton.setFont(new java.awt.Font("Dialog", 0, 12));
        from2ToRadioButton.setSelected(true);
        from2ToRadioButton.setText(bundle.getString("NBBranchPositivePanel.from2ToRadioButton.text")); // NOI18N
        ...
        to2FromRadioButton.setText(bundle.getString("NBBranchPositivePanel.to2FromRadioButton.text")); // NOI18N
        ...
        tapVControlCheckBox.setText(bundle.getString("NBBranchPositivePanel.tapVControlCheckBox.text")); // NOI18N
        ...
        leftLabel.setText(bundle.getString("NBBranchPositivePanel.leftLabel.text")); // NOI18N
        ...
        voltageRadioButton.setSelected(true);
        voltageRadioButton.setText(bundle.getString("NBBranchPositivePanel.voltageRadioButton.text")); // NOI18N
        ...
        mvaFlowRadioButton.setText(bundle.getString("NBBranchPositivePanel.mvaFlowRadioButton.text")); // NOI18N
        ...
        rightLabel.setText(bundle.getString("NBBranchPositivePanel.rightLabel.text")); // NOI18N
        ...
        vcBusLabel.setText(bundle.getString("NBBranchPositivePanel.vcBusLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        ...
        vSpecLabel.setText(bundle.getString("NBBranchPositivePanel.vSpecLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 1;
        ...
        vSpecTextField.setText(bundle.getString("NBBranchPositivePanel.vSpecTextField.text")); // NOI18N
        ...
        vcBusSidePanel.setBorder(javax.swing.BorderFactory.createTitledBorder(null, bundle.getString("NBBranchPositivePanel.vcBusSidePanel.border.title"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 10))); // NOI18N

        vcBusOnButtonGroup.add(vcBusFromSideRadioButton);
        vcBusFromSideRadioButton.setFont(new java.awt.Font("Dialog", 0, 12));
        vcBusFromSideRadioButton.setSelected(true);
        vcBusFromSideRadioButton.setText(bundle.getString("NBBranchPositivePanel.vcBusFromSideRadioButton.text")); // NOI18N
        ...
        vcBusToSideRadioButton.setText(bundle.getString("NBBranchPositivePanel.vcBusToSideRadioButton.text")); // NOI18N
        ...
        controlTapSidePanel.setBorder(javax.swing.BorderFactory.createTitledBorder(null, bundle.getString("NBBranchPositivePanel.controlTapSidePanel.border.title"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 10))); // NOI18N
        ...
        controlTapOnFromSideRadioButton.setSelected(true);
        controlTapOnFromSideRadioButton.setText(bundle.getString("NBBranchPositivePanel.controlTapOnFromSideRadioButton.text")); // NOI18N
        ...
        controlTapOnToSideRadioButton.setText(bundle.getString("NBBranchPositivePanel.controlTapOnToSideRadioButton.text")); // NOI18N
        ...
        controlTapMaxLabel.setText(bundle.getString("NBBranchPositivePanel.controlTapMaxLabel.text")); // NOI18N
        ...
        controlTapMaxTextField.setText(bundle.getString("NBBranchPositivePanel.controlTapMaxTextField.text")); // NOI18N
        ...
        controlTapMinLabel.setText(bundle.getString("NBBranchPositivePanel.controlTapMinLabel.text")); // NOI18N
        ...
        controlTapMinTextField.setText(bundle.getString("NBBranchPositivePanel.controlTapMinTextField.text")); // NOI18N
        ...
        controlTapStepsLabel.setText(bundle.getString("NBBranchPositivePanel.controlTapStepsLabel.text")); // NOI18N
        ...
        controlTapStepTextField.setText(bundle.getString("NBBranchPositivePanel.controlTapStepTextField.text")); // NOI18N
        ...
        branchTabbedPane.addTab(bundle.getString("NBBranchPositivePanel.dataPanel.TabConstraints.tabTitle"), dataPanel); // NOI18N
        branchTabbedPane.addTab(bundle.getString("NBBranchPositivePanel.scriptPanel.TabConstraints.tabTitle"), scriptPanel); // NOI18N
