...
public class NBAcscTransBusEditPanel extends javax.swing.JPanel implements IFormDataPanel {
    ...
    private void initComponents() {
        ...
        acscTabbedPane.addTab(bundle.getString("NBAcscTransBusEditPanel.aclfInfoEditPanel.TabConstraints.tabTitle"), aclfInfoEditPanel); // NOI18N

        acscInfoEditPanel.setLayout(new java.awt.GridBagLayout());

        scBusTypePanel.setBorder(javax.swing.BorderFactory.createTitledBorder(null, bundle.getString("NBAcscTransBusEditPanel.scBusTypePanel.border.title"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 10))); // NOI18N
        ...
        contributeRadioButton.setText(bundle.getString("NBAcscTransBusEditPanel.contributeRadioButton.text")); // NOI18N
        ...
        nonContributeRadioButton.setSelected(true);
        nonContributeRadioButton.setText(bundle.getString("NBAcscTransBusEditPanel.nonContributeRadioButton.text")); // NOI18N
        ...
        scriptRadioButton.setText(bundle.getString("NBAcscTransBusEditPanel.scriptRadioButton.text")); // NOI18N
        ...
        r1Label.setText(bundle.getString("NBAcscTransBusEditPanel.r1Label.text")); // NOI18N
        ...
        r1TextField.setText(bundle.getString("NBAcscTransBusEditPanel.r1TextField.text")); // NOI18N
        ...
        x1Label.setText(bundle.getString("NBAcscTransBusEditPanel.x1Label.text")); // NOI18N
        ...
        x1TextField.setText(bundle.getString("NBAcscTransBusEditPanel.x1TextField.text")); // NOI18N
        ...
        r2Label.setText(bundle.getString("NBAcscTransBusEditPanel.r2Label.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        r2TextField.setText(bundle.getString("NBAcscTransBusEditPanel.r2TextField.text")); // NOI18N
        ...
        x2Label.setText(bundle.getString("NBAcscTransBusEditPanel.x2Label.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridy = 1;
        ...
        x2TextField.setText(bundle.getString("NBAcscTransBusEditPanel.x2TextField.text")); // NOI18N
        ...
        r0Label.setText(bundle.getString("NBAcscTransBusEditPanel.r0Label.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        r0TextField.setText(bundle.getString("NBAcscTransBusEditPanel.r0TextField.text")); // NOI18N
        ...
        x0Label.setText(bundle.getString("NBAcscTransBusEditPanel.x0Label.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridy = 2;
        ...
        x0TextField.setText(bundle.getString("NBAcscTransBusEditPanel.x0TextField.text")); // NOI18N
        ...
        acscTabbedPane.addTab(bundle.getString("NBAcscTransBusEditPanel.acscInfoEditPanel.TabConstraints.tabTitle"), acscInfoEditPanel); // NOI18N
        acscTabbedPane.addTab(bundle.getString("NBAcscTransBusEditPanel.scriptPanel.TabConstraints.tabTitle"), scriptPanel); // NOI18N
