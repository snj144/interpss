...
public class NBBusEditDialog extends javax.swing.JDialog  implements IFormDataDialog {
	...
	*/
    ...
    private void initComponents() {
        ...
        setTitle(bundle.getString("NBBusEditDialog.title")); // NOI18N
        setAlwaysOnTop(true);
        setModal(true);
        ...
        busNumberLabel.setText(bundle.getString("NBBusEditDialog.busNumberLabel.text")); // NOI18N
        idPanel.add(busNumberLabel);

        busNameLabel.setFont(new java.awt.Font("Dialog", 0, 10));
        busNameLabel.setText(bundle.getString("NBBusEditDialog.busNameLabel.text")); // NOI18N
        ...
        baseVoltLabel.setText(bundle.getString("NBBusEditDialog.baseVoltLabel.text")); // NOI18N
        ...
        areaLabel.setText(bundle.getString("NBBusEditDialog.areaLabel.text")); // NOI18N
        idPanel.add(areaLabel);

        areaField.setColumns(2);
        areaField.setFont(new java.awt.Font("Dialog", 0, 10));
        areaField.setText(bundle.getString("NBBusEditDialog.areaField.text")); // NOI18N
        areaField.setName("areaTextField"); // NOI18N
        idPanel.add(areaField);

        zoneLabel.setFont(new java.awt.Font("Dialog", 0, 10));
        zoneLabel.setText(bundle.getString("NBBusEditDialog.zoneLabel.text")); // NOI18N
        idPanel.add(zoneLabel);

        zoneField.setColumns(2);
        zoneField.setFont(new java.awt.Font("Dialog", 0, 10));
        zoneField.setText(bundle.getString("NBBusEditDialog.zoneField.text")); // NOI18N
        ...
        inServiceCheckBox.setText(bundle.getString("NBBusEditDialog.inServiceCheckBox.text")); // NOI18N
        ...
        saveButton.setText(bundle.getString("NBBusEditDialog.saveButton.text")); // NOI18N
        ...
        cancelButton.setText(bundle.getString("NBBusEditDialog.cancelButton.text")); // NOI18N
