...
public class NBExciterPanel extends javax.swing.JPanel implements IFormDataPanel {
    ...
    private void initComponents() {
        ...
        catyLabel.setText(bundle.getString("NBExciterPanel.catyLabel.text")); // NOI18N
        ...
        catyListComboBox.setName("typeListComboBox"); // NOI18N
        ...
        typeLabel.setText(bundle.getString("NBExciterPanel.typeLabel.text")); // NOI18N
        selectPanel.add(typeLabel);

        typeListComboBox.setFont(new java.awt.Font("Dialog", 0, 12));
        typeListComboBox.setName("typeListComboBox"); // NOI18N
        ...
        pssCheckBox.setText(bundle.getString("NBExciterPanel.pssCheckBox.text")); // NOI18N
        pssCheckBox.setName("pssCheckBox"); // NOI18N
