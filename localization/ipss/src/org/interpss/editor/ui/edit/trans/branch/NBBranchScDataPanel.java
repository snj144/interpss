...
public class NBBranchScDataPanel extends javax.swing.JPanel implements IFormDataPanel {
    ...
    private void initComponents() {
        ...
        branchTypePanel.setBorder(javax.swing.BorderFactory.createTitledBorder(null, bundle.getString("NBBranchScDataPanel.branchTypePanel.border.title"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 10))); // NOI18N
        ...
        lineRadioButton.setSelected(true);
        lineRadioButton.setText(bundle.getString("NBBranchScDataPanel.lineRadioButton.text")); // NOI18N
        ...
        xfrRadioButton.setText(bundle.getString("NBBranchScDataPanel.xfrRadioButton.text")); // NOI18N
        ...
        psXfrRadioButton.setText(bundle.getString("NBBranchScDataPanel.psXfrRadioButton.text")); // NOI18N
        ...
        scriptRadioButton.setText(bundle.getString("NBBranchScDataPanel.scriptRadioButton.text")); // NOI18N
        ...
        r1Label.setText(bundle.getString("NBBranchScDataPanel.r1Label.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        ...
        r1TextField.setText(bundle.getString("NBBranchScDataPanel.r1TextField.text")); // NOI18N
        ...
        x1Label.setText(bundle.getString("NBBranchScDataPanel.x1Label.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        x1TextField.setText(bundle.getString("NBBranchScDataPanel.x1TextField.text")); // NOI18N
        ...
        r0Label.setText(bundle.getString("NBBranchScDataPanel.r0Label.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        r0TextField.setText(bundle.getString("NBBranchScDataPanel.r0TextField.text")); // NOI18N
        ...
        x0Label.setText(bundle.getString("NBBranchScDataPanel.x0Label.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        x0TextField.setText(bundle.getString("NBBranchScDataPanel.x0TextField.text")); // NOI18N
        ...
        hB1Label.setText(bundle.getString("NBBranchScDataPanel.hB1Label.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        hB1TextField.setText(bundle.getString("NBBranchScDataPanel.hB1TextField.text")); // NOI18N
        ...
        hB0Label.setText(bundle.getString("NBBranchScDataPanel.hB0Label.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        hB0TextField.setText(bundle.getString("NBBranchScDataPanel.hB0TextField.text")); // NOI18N
        ...
        fromTapLabel.setText(bundle.getString("NBBranchScDataPanel.fromTapLabel.text")); // NOI18N
        ...
        fromTapTextField.setText(bundle.getString("NBBranchScDataPanel.fromTapTextField.text")); // NOI18N
        ...
        toTapLabel.setText(bundle.getString("NBBranchScDataPanel.toTapLabel.text")); // NOI18N
        ...
        toTapTextField.setText(bundle.getString("NBBranchScDataPanel.toTapTextField.text")); // NOI18N
