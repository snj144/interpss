...
public class NBXformerInputPanel extends javax.swing.JPanel implements IFormDataPanel {
    ...
    private void initComponents() {
        ...
        nameLabel.setText(bundle.getString("NBXformerInputPanel.nameLabel.text")); // NOI18N
        ...
        xfrNameComboBox.setName("xfrNameComboBox"); // NOI18N
        paramPanel.add(xfrNameComboBox, new java.awt.GridBagConstraints());

        ratingLabel.setFont(new java.awt.Font("Dialog", 0, 12));
        ratingLabel.setText(bundle.getString("NBXformerInputPanel.ratingLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        ...
        xfrRatingField.setText(bundle.getString("NBXformerInputPanel.xfrRatingField.text")); // NOI18N
        xfrRatingField.setName("xfrRatingTextField"); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        ratingUnitComboBox.setName("ratingUnitComboBox"); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.insets = new java.awt.Insets(0, 5, 0, 5);
        paramPanel.add(ratingUnitComboBox, gridBagConstraints);

        fromRatedVLabel.setFont(new java.awt.Font("Dialog", 0, 12));
        fromRatedVLabel.setText(bundle.getString("NBXformerInputPanel.fromRatedVLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        fromRatedVTextField.setText(bundle.getString("NBXformerInputPanel.fromRatedVTextField.text")); // NOI18N
        fromRatedVTextField.setName("fromRatedVTextField"); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridy = 1;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        toRatedVLabel.setText(bundle.getString("NBXformerInputPanel.toRatedVLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridy = 1;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(0, 20, 0, 5);
        ...
        toRatedVTextField.setName("toRatedVTextField"); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridy = 1;
        ...
        voltUnitComboBox.setName("voltUnitComboBox"); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridy = 1;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        xLabel.setText(bundle.getString("NBXformerInputPanel.xLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        xField.setText(bundle.getString("NBXformerInputPanel.xField.text")); // NOI18N
        xField.setName("xTextField"); // NOI18N
        ...
        rLabel.setText(bundle.getString("NBXformerInputPanel.rLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridy = 2;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        ...
        rField.setText(bundle.getString("NBXformerInputPanel.rField.text")); // NOI18N
        rField.setName("rTextField"); // NOI18N
        ...
        zUnitComboBox.setName("zUnitComboBox"); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridy = 2;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(0, 5, 0, 5);
        ...
        x_rLabel.setText(bundle.getString("NBXformerInputPanel.x_rLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridy = 2;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(0, 20, 0, 5);
        ...
        x_rField.setText(bundle.getString("NBXformerInputPanel.x_rField.text")); // NOI18N
        x_rField.setName("x_rTextField"); // NOI18N
        ...
        x0_x1Label.setText(bundle.getString("NBXformerInputPanel.x0_x1Label.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        x0_x1Field.setText(bundle.getString("NBXformerInputPanel.x0_x1Field.text")); // NOI18N
        x0_x1Field.setName("x0_x1TextField"); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridy = 3;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        r0_r1Label.setText(bundle.getString("NBXformerInputPanel.r0_r1Label.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridy = 3;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        ...
        r0_r1Field.setText(bundle.getString("NBXformerInputPanel.r0_r1Field.text")); // NOI18N
        r0_r1Field.setName("r0_r1TextField"); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridy = 3;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        fromTapLabel.setText(bundle.getString("NBXformerInputPanel.fromTapLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        fromTapField.setText(bundle.getString("NBXformerInputPanel.fromTapField.text")); // NOI18N
        fromTapField.setName("fromTapTextField"); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridy = 4;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        toTapLabel.setText(bundle.getString("NBXformerInputPanel.toTapLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridy = 4;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(0, 0, 0, 5);
        ...
        toTapField.setText(bundle.getString("NBXformerInputPanel.toTapField.text")); // NOI18N
        toTapField.setName("toTapTextField"); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridy = 4;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        tapUnitComboBox.setName("tapUnitComboBox"); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridy = 4;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(0, 5, 0, 5);
        ...
        includeSScheduleCheckBox.setText(bundle.getString("NBXformerInputPanel.includeSScheduleCheckBox.text")); // NOI18N
        ...
        serviceScheduleButton.setText(bundle.getString("NBXformerInputPanel.serviceScheduleButton.text")); // NOI18N
