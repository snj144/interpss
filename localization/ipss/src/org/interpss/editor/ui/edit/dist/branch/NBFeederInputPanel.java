...
public class NBFeederInputPanel extends javax.swing.JPanel implements IFormDataPanel {
    ...
    private void initComponents() {
        ...
        nameLabel.setText(bundle.getString("NBFeederInputPanel.nameLabel.text")); // NOI18N
        ...
        nameComboBox.setName("nameComboBox"); // NOI18N
        add(nameComboBox, new java.awt.GridBagConstraints());

        lengthLabel.setFont(new java.awt.Font("Dialog", 0, 12));
        lengthLabel.setText(bundle.getString("NBFeederInputPanel.lengthLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        ...
        lengthField.setText(bundle.getString("NBFeederInputPanel.lengthField.text")); // NOI18N
        lengthField.setName("lengthTextField"); // NOI18N
        ...
        lengthUnitComboBox.setName("lengthUnitComboBox"); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        x_1000Label.setText(bundle.getString("NBFeederInputPanel.x_1000Label.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        x_1000Field.setText(bundle.getString("NBFeederInputPanel.x_1000Field.text")); // NOI18N
        x_1000Field.setName("x_1000TextField"); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridy = 1;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        r_1000Label.setText(bundle.getString("NBFeederInputPanel.r_1000Label.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridy = 1;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(0, 20, 0, 5);
        ...
        r_1000Field.setText(bundle.getString("NBFeederInputPanel.r_1000Field.text")); // NOI18N
        r_1000Field.setName("r_1000TextField"); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridy = 1;
        add(r_1000Field, gridBagConstraints);

        zUnitLabel.setFont(new java.awt.Font("Dialog", 0, 10));
        zUnitLabel.setText(bundle.getString("NBFeederInputPanel.zUnitLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridy = 1;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        x0_x1Label.setText(bundle.getString("NBFeederInputPanel.x0_x1Label.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        x0_x1Field.setText(bundle.getString("NBFeederInputPanel.x0_x1Field.text")); // NOI18N
        ...
        r0_r1Label.setText(bundle.getString("NBFeederInputPanel.r0_r1Label.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridy = 2;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(0, 0, 0, 5);
        ...
        r0_r1Field.setText(bundle.getString("NBFeederInputPanel.r0_r1Field.text")); // NOI18N
        ...
        b1_1000Label.setText(bundle.getString("NBFeederInputPanel.b1_1000Label.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        b1_1000Field.setText(bundle.getString("NBFeederInputPanel.b1_1000Field.text")); // NOI18N
        b1_1000Field.setName("b1_1000TextField"); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridy = 3;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        b0_1000Label.setText(bundle.getString("NBFeederInputPanel.b0_1000Label.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridy = 3;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        gridBagConstraints.insets = new java.awt.Insets(0, 0, 0, 5);
        ...
        b0_b1Field.setText(bundle.getString("NBFeederInputPanel.b0_b1Field.text")); // NOI18N
        b0_b1Field.setName("b0_b1TextField"); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridy = 3;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        bUnitLabel.setText(bundle.getString("NBFeederInputPanel.bUnitLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridy = 3;
        gridBagConstraints.insets = new java.awt.Insets(0, 5, 0, 0);
