...
public class NBAcscTransBranchEditPanel extends javax.swing.JPanel implements IFormDataPanel {
    ...
    private void initComponents() {
        ...
        branchInfoEditTabbedPane.addTab(bundle.getString("NBAcscTransBranchEditPanel.lfInfoEditPanel.TabConstraints.tabTitle"), lfInfoEditPanel); // NOI18N
        branchInfoEditTabbedPane.addTab(bundle.getString("NBAcscTransBranchEditPanel.scInfoEditPanel.TabConstraints.tabTitle"), scInfoEditPanel); // NOI18N
        branchInfoEditTabbedPane.addTab(bundle.getString("NBAcscTransBranchEditPanel.scriptPanel.TabConstraints.tabTitle"), scriptPanel); // NOI18N
