...
public class NBProjectEditDialog extends javax.swing.JDialog implements IFormDataDialog {
	...
	*/
    ...
    private void initComponents() {
        ...
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("org/interpss/editor/ui/edit/Bundle"); // NOI18N
        projFileLabel.setText(bundle.getString("NBProjectEditDialog.projFileLabel.text")); // NOI18N
        ...
        filenameLabel.setText(bundle.getString("NBProjectEditDialog.filenameLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridy = 0;
        gridBagConstraints.ipady = 5;
        ...
        descLabel.setText(bundle.getString("NBProjectEditDialog.descLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        baseKvaLabel.setText(bundle.getString("NBProjectEditDialog.baseKvaLabel.text")); // NOI18N
        kvaPanel.add(baseKvaLabel);

        baseKvaField.setColumns(8);
        baseKvaField.setText(bundle.getString("NBProjectEditDialog.baseKvaField.text")); // NOI18N
        baseKvaField.setName("baseKvaTextField"); // NOI18N
        kvaPanel.add(baseKvaField);

        kvaUnitLabel.setFont(new java.awt.Font("Dialog", 0, 10));
        kvaUnitLabel.setText(bundle.getString("NBProjectEditDialog.kvaUnitLabel.text")); // NOI18N
        ...
        baseFreqLabel.setText(bundle.getString("NBProjectEditDialog.baseFreqLabel.text")); // NOI18N
        kvaPanel.add(baseFreqLabel);

        baseFreqField.setColumns(4);
        baseFreqField.setText(bundle.getString("NBProjectEditDialog.baseFreqField.text")); // NOI18N
        baseFreqField.setName("baseFreqTextField"); // NOI18N
        kvaPanel.add(baseFreqField);

        fUnitLabel.setFont(new java.awt.Font("Dialog", 0, 10));
        fUnitLabel.setText(bundle.getString("NBProjectEditDialog.fUnitLabel.text")); // NOI18N
        ...
        appTypePanel.setBorder(javax.swing.BorderFactory.createTitledBorder(null, bundle.getString("NBProjectEditDialog.appTypePanel.border.title"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 10))); // NOI18N
        ...
        transAppRadioButton.setText(bundle.getString("NBProjectEditDialog.transAppRadioButton.text")); // NOI18N
        ...
        distriAppRadioButton.setText(bundle.getString("NBProjectEditDialog.distriAppRadioButton.text")); // NOI18N
        ...
        netTypePanel.setBorder(javax.swing.BorderFactory.createTitledBorder(null, bundle.getString("NBProjectEditDialog.netTypePanel.border.title"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 10))); // NOI18N
        ...
        aclfNetRadioButton.setText(bundle.getString("NBProjectEditDialog.aclfNetRadioButton.text")); // NOI18N
        ...
        acscNetRadioButton.setText(bundle.getString("NBProjectEditDialog.acscNetRadioButton.text")); // NOI18N
        ...
        dstabNetRadioButton.setText(bundle.getString("NBProjectEditDialog.dstabNetRadioButton.text")); // NOI18N
        ...
        configInfoTabbedPane.addTab(bundle.getString("NBProjectEditDialog.editContainerPanel.TabConstraints.tabTitle"), editContainerPanel); // NOI18N

        leftEncloseLabel.setFont(new java.awt.Font("Dialog", 0, 12));
        leftEncloseLabel.setText(bundle.getString("NBProjectEditDialog.leftEncloseLabel.text")); // NOI18N
        ...
        interfaceNetConfigRadioButton.setText(bundle.getString("NBProjectEditDialog.interfaceNetConfigRadioButton.text")); // NOI18N
        ...
        areaNetConfigRadioButton.setFont(new java.awt.Font("Dialog", 0, 12));
        areaNetConfigRadioButton.setText(bundle.getString("NBProjectEditDialog.areaNetConfigRadioButton.text")); // NOI18N
        ...
        zoneNetConfigRadioButton.setFont(new java.awt.Font("Dialog", 0, 12));
        zoneNetConfigRadioButton.setText(bundle.getString("NBProjectEditDialog.zoneNetConfigRadioButton.text")); // NOI18N
        ...
        rightEncloseLabel.setText(bundle.getString("NBProjectEditDialog.rightEncloseLabel.text")); // NOI18N
        netCfgSelectPanel.add(rightEncloseLabel);

        netCfgItemList.setFont(new java.awt.Font("Dialog", 0, 12));
        ...
        netCfgNumberLabel.setText(bundle.getString("NBProjectEditDialog.netCfgNumberLabel.text")); // NOI18N

        netCfgNameLabel.setFont(new java.awt.Font("Dialog", 0, 12));
        netCfgNameLabel.setText(bundle.getString("NBProjectEditDialog.netCfgNameLabel.text")); // NOI18N

        netCfgDescLabel.setFont(new java.awt.Font("Dialog", 0, 12));
        netCfgDescLabel.setText(bundle.getString("NBProjectEditDialog.netCfgDescLabel.text")); // NOI18N

        netCfgNumberTextField.setColumns(3);
        netCfgNumberTextField.setFont(new java.awt.Font("Dialog", 0, 12));
        netCfgNumberTextField.setText(bundle.getString("NBProjectEditDialog.netCfgNumberTextField.text")); // NOI18N

        netCfgNameTextField.setColumns(5);
        netCfgNameTextField.setFont(new java.awt.Font("Dialog", 0, 12));
        netCfgNameTextField.setText(bundle.getString("NBProjectEditDialog.netCfgNameTextField.text")); // NOI18N

        netCfgDescTextField.setColumns(10);
        netCfgDescTextField.setFont(new java.awt.Font("Dialog", 0, 12));
        netCfgDescTextField.setText(bundle.getString("NBProjectEditDialog.netCfgDescTextField.text")); // NOI18N
        ...
        interfaceBranchEditPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(null, bundle.getString("NBProjectEditDialog.interfaceBranchEditPanel.border.title"), javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 10))); // NOI18N
        ...
        interfaceMvaRatingLabel.setFont(new java.awt.Font("Dialog", 0, 12));
        interfaceMvaRatingLabel.setText(bundle.getString("NBProjectEditDialog.interfaceMvaRatingLabel.text")); // NOI18N

        interfaceMvaRatingTextField.setColumns(3);
        interfaceMvaRatingTextField.setFont(new java.awt.Font("Dialog", 0, 12));
        interfaceMvaRatingTextField.setText(bundle.getString("NBProjectEditDialog.interfaceMvaRatingTextField.text")); // NOI18N

        interfaceLabel.setFont(new java.awt.Font("Dialog", 0, 12));
        interfaceLabel.setText(bundle.getString("NBProjectEditDialog.interfaceLabel.text")); // NOI18N

        networkBranchLabel.setFont(new java.awt.Font("Dialog", 0, 12));
        networkBranchLabel.setText(bundle.getString("NBProjectEditDialog.networkBranchLabel.text")); // NOI18N

        networkBranchComboBox.setFont(new java.awt.Font("Dialog", 0, 12));
        networkBranchComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));

        participationLabel.setFont(new java.awt.Font("Dialog", 0, 12));
        participationLabel.setText(bundle.getString("NBProjectEditDialog.participationLabel.text")); // NOI18N

        participationTextField.setColumns(3);
        participationTextField.setFont(new java.awt.Font("Dialog", 0, 12));
        participationTextField.setText(bundle.getString("NBProjectEditDialog.participationTextField.text")); // NOI18N

        percentLabel.setFont(new java.awt.Font("Dialog", 0, 12));
        percentLabel.setText(bundle.getString("NBProjectEditDialog.percentLabel.text")); // NOI18N

        editInterfaceBranchButton.setFont(new java.awt.Font("Dialog", 0, 10));
        editInterfaceBranchButton.setText(bundle.getString("NBProjectEditDialog.editInterfaceBranchButton.text")); // NOI18N
        ...
        updateInterfaceBranchButton.setFont(new java.awt.Font("Dialog", 0, 10));
        updateInterfaceBranchButton.setText(bundle.getString("NBProjectEditDialog.updateInterfaceBranchButton.text")); // NOI18N
        ...
        netCfgEditButton.setFont(new java.awt.Font("Dialog", 0, 12));
        netCfgEditButton.setText(bundle.getString("NBProjectEditDialog.netCfgEditButton.text")); // NOI18N
        ...
        netCfgAddButton.setText(bundle.getString("NBProjectEditDialog.netCfgAddButton.text")); // NOI18N
        ...
        netCfgUpdateButton.setText(bundle.getString("NBProjectEditDialog.netCfgUpdateButton.text")); // NOI18N
        ...
        netCfgInfoPanelLayout.setVerticalGroup(
            ...
            .add(netCfgInfoPanelLayout.createSequentialGroup()
                ...
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(interfaceBranchEditPanel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 127, Short.MAX_VALUE)
                .add(18, 18, 18)
        ...
        configInfoTabbedPane.addTab(bundle.getString("NBProjectEditDialog.netConfigPanel.TabConstraints.tabTitle"), netConfigPanel); // NOI18N
        ...
        saveButton.setText(bundle.getString("NBProjectEditDialog.saveButton.text")); // NOI18N
        ...
        cancelButton.setText(bundle.getString("NBProjectEditDialog.cancelButton.text")); // NOI18N
