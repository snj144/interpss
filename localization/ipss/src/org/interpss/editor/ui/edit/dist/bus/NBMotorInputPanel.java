...
public class NBMotorInputPanel extends javax.swing.JPanel  implements IFormDataPanel {
    ...
    private void initComponents() {
        ...
        ratedHPLabel.setText(bundle.getString("NBMotorInputPanel.ratedHPLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.insets = new java.awt.Insets(0, 0, 0, 5);
        add(ratedHPLabel, gridBagConstraints);

        ratedHPField.setColumns(8);
        ratedHPField.setText(bundle.getString("NBMotorInputPanel.ratedHPField.text")); // NOI18N
        ratedHPField.setName("ratedHPTextField"); // NOI18N
        ...
        ratedHPUnitComboBox.setName("ratedHPUnitComboBox"); // NOI18N
        add(ratedHPUnitComboBox, new java.awt.GridBagConstraints());

        ratedVLabel.setFont(new java.awt.Font("Dialog", 0, 12));
        ratedVLabel.setText(bundle.getString("NBMotorInputPanel.ratedVLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        ratedVTextField.setText(bundle.getString("NBMotorInputPanel.ratedVTextField.text")); // NOI18N
        ratedVTextField.setName("ratedVTextField"); // NOI18N
        ...
        ratedVUnitComboBox.setName("ratedVUnitComboBox"); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        add(ratedVUnitComboBox, gridBagConstraints);

        pfLabel.setFont(new java.awt.Font("Dialog", 0, 12));
        pfLabel.setText(bundle.getString("NBMotorInputPanel.pfLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        pfField.setText(bundle.getString("NBMotorInputPanel.pfField.text")); // NOI18N
        pfField.setName("pfTextField"); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridy = 1;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        pfUnitComboBox.setName("pfUnitComboBox"); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridy = 1;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        effLabel.setText(bundle.getString("NBMotorInputPanel.effLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridy = 1;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.EAST;
        ...
        effTextField.setText(bundle.getString("NBMotorInputPanel.effTextField.text")); // NOI18N
        effTextField.setName("effTextField"); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridy = 1;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        loadingLabel.setText(bundle.getString("NBMotorInputPanel.loadingLabel.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridy = 1;
        gridBagConstraints.insets = new java.awt.Insets(0, 0, 0, 5);
        ...
        loadingTextField.setText(bundle.getString("NBMotorInputPanel.loadingTextField.text")); // NOI18N
        loadingTextField.setName("loadingTextField"); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridy = 1;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        ...
        includeLScheduleCheckBox.setText(bundle.getString("NBMotorInputPanel.includeLScheduleCheckBox.text")); // NOI18N
        ...
        loadScheduleButton.setText(bundle.getString("NBMotorInputPanel.loadScheduleButton.text")); // NOI18N
