...
public class NBDStabTransBusEditPanel extends javax.swing.JPanel implements IFormDataPanel, IEditUIEventListener {
	...
	public void initPanel(JDialog aParent) {
		...
		this.scriptingEditPanel.add(customScriptEditPanel);
	...
	public void init(Object netContainer, Object form) {
		...
		customScriptEditPanel.init(_form.getDStabBusData(), NBCustomScriptEditPanel.Type.DynamicBusDevice);
	}
	...
	public void setScriptingTabbedPaneEnabled(boolean e) {
	    ...
	    if (e) {
			...
			setGovTabbedPaneEnabled(false);
			setPssTabbedPaneEnabled(false);
			customScriptEditPanel.setForm2Editor();
		}
	    else
	    	setTabbedPanel();
	}
    ...
    public boolean saveEditor2Form(Vector<String> errMsg) throws Exception {
    	...
    	if (scriptingCheckBox.isSelected()) {
			customScriptEditPanel.saveEditor2Form(errMsg);
    	}
    	else {
        	if (_form.getDStabBusData().isMachineBus()) {
    ...
    private void initComponents() {
        ...
        scriptButtonGroup = new javax.swing.ButtonGroup();
        ...
        scriptingCheckBox.setText(bundle.getString("NBDStabTransBusEditPanel.scriptingCheckBox.text")); // NOI18N
        ...
        dstabTabbedPane.addTab(bundle.getString("NBDStabTransBusEditPanel.mainEditPanel.TabConstraints.tabTitle"), mainEditPanel); // NOI18N

        machInfoEditPanel.setLayout(new java.awt.BorderLayout());
        dstabTabbedPane.addTab(bundle.getString("NBDStabTransBusEditPanel.machInfoEditPanel.TabConstraints.tabTitle"), machInfoEditPanel); // NOI18N

        excInfoEditPanel.setLayout(new java.awt.BorderLayout());
        dstabTabbedPane.addTab(bundle.getString("NBDStabTransBusEditPanel.excInfoEditPanel.TabConstraints.tabTitle"), excInfoEditPanel); // NOI18N

        govInfoEditPanel.setLayout(new java.awt.BorderLayout());
        dstabTabbedPane.addTab(bundle.getString("NBDStabTransBusEditPanel.govInfoEditPanel.TabConstraints.tabTitle"), govInfoEditPanel); // NOI18N

        pssInfoEditPanel.setLayout(new java.awt.BorderLayout());
        dstabTabbedPane.addTab(bundle.getString("NBDStabTransBusEditPanel.pssInfoEditPanel.TabConstraints.tabTitle"), pssInfoEditPanel); // NOI18N
        dstabTabbedPane.addTab(bundle.getString("NBDStabTransBusEditPanel.scriptingEditPanel.TabConstraints.tabTitle"), scriptingEditPanel); // NOI18N

        add(dstabTabbedPane, java.awt.BorderLayout.PAGE_START);
    ...
    private javax.swing.ButtonGroup scriptButtonGroup;
