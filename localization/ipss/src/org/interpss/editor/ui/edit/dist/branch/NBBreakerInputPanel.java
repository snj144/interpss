...
public class NBBreakerInputPanel extends javax.swing.JPanel implements IFormDataPanel {
    ...
    private void initComponents() {
        ...
        nameLabel.setText(bundle.getString("NBBreakerInputPanel.nameLabel.text")); // NOI18N
        ...
        rLabel.setText(bundle.getString("NBBreakerInputPanel.rLabel.text")); // NOI18N
        add(rLabel, new java.awt.GridBagConstraints());

        rField.setColumns(6);
        rField.setText(bundle.getString("NBBreakerInputPanel.rField.text")); // NOI18N
        ...
        rUnitLabel.setText(bundle.getString("NBBreakerInputPanel.rUnitLabel.text")); // NOI18N
        add(rUnitLabel, new java.awt.GridBagConstraints());

        serviceScheduleButton.setFont(new java.awt.Font("Dialog", 0, 10));
        serviceScheduleButton.setText(bundle.getString("NBBreakerInputPanel.serviceScheduleButton.text")); // NOI18N
        ...
        includeSScheduleCheckBox.setText(bundle.getString("NBBreakerInputPanel.includeSScheduleCheckBox.text")); // NOI18N
