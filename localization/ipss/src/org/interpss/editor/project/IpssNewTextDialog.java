...
public class IpssNewTextDialog extends javax.swing.JDialog {
	...
	protected void initGuiComponents() {
		...
		selectpanel.setBorder(new TitledBorder(null, Translator.getString("TextDialog.Contents"),
		...
		nameLabel.setText(Translator.getString("TextDialog.TextFileName"));
	...
	public void selectFile() {
		try {
			...
			if (in != null) {
				...
				if (getFile() == null) {
					showError(Translator.getString("TextDialog.CantOpenError"));
					return;
				}
			}
		} catch (Exception ex) {
