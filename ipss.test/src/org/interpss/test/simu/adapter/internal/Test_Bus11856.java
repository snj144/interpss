...
public class Test_Bus11856 extends TestBaseAppCtx {
	public void testCase1() throws Exception {
  		System.out.println("Test_Bus11856 testCase1 begins ...");
		...
		AclfNetwork net = simuCtx.getAclfNet();
  		...
  		assertEquals(true, (net.getBusList().size() == 11856));
  		...
  		System.out.println("Test_Bus11856 testCase1 ends");
	}
}
