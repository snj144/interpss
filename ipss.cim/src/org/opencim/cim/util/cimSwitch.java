 ...
 * </copyright>
 *
 * $Id: cimSwitch.java,v 1.2 2007/03/03 02:50:01 mzhou Exp $
 */
...
public class cimSwitch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case cimPackage.COMBINED_VERSION: {
				CombinedVersion combinedVersion = (CombinedVersion)theEObject;
				Object result = caseCombinedVersion(combinedVersion);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case cimPackage.SIMULATION_MODEL: {
				SimulationModel simulationModel = (SimulationModel)theEObject;
				Object result = caseSimulationModel(simulationModel);
				if (result == null) result = caseNaming(simulationModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
