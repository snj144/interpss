 ...
 * </copyright>
 *
 * $Id: IncrementalHeatRateCurveImpl.java,v 1.1 2007/03/02 14:01:10 mzhou Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.opencim.cim.iec61970.gen.production.impl.IncrementalHeatRateCurveImpl#getNetGrossMWFlag <em>Net Gross MW Flag</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class IncrementalHeatRateCurveImpl extends CurveScheduleImpl implements IncrementalHeatRateCurve {
	/**
	...
	public void setNetGrossMWFlag(Boolean newNetGrossMWFlag) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProductionPackage.INCREMENTAL_HEAT_RATE_CURVE__NET_GROSS_MW_FLAG, oldNetGrossMWFlag, netGrossMWFlag));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ProductionPackage.INCREMENTAL_HEAT_RATE_CURVE__NET_GROSS_MW_FLAG:
