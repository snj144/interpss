    ...
    extends GovernorModelXmlType
{
    ...
    @XmlElement(name = "VOpen", namespace = "http://www.ieee.org/odm/Schema/2008")
    protected double vOpen;
    @XmlElement(name = "VClose", namespace = "http://www.ieee.org/odm/Schema/2008")
    ...
    @XmlElement(name = "K1", namespace = "http://www.ieee.org/odm/Schema/2008")
    protected double k1;
    @XmlElement(name = "K2", namespace = "http://www.ieee.org/odm/Schema/2008")
    protected double k2;
    @XmlElement(name = "T5", namespace = "http://www.ieee.org/odm/Schema/2008", required = true)
    protected TimePeriodXmlType t5;
    @XmlElement(name = "K3", namespace = "http://www.ieee.org/odm/Schema/2008")
    protected double k3;
    @XmlElement(name = "K4", namespace = "http://www.ieee.org/odm/Schema/2008")
    protected double k4;
    @XmlElement(name = "T6", namespace = "http://www.ieee.org/odm/Schema/2008", required = true)
    protected TimePeriodXmlType t6;
    @XmlElement(name = "K5", namespace = "http://www.ieee.org/odm/Schema/2008")
    protected double k5;
    @XmlElement(name = "K6", namespace = "http://www.ieee.org/odm/Schema/2008")
    protected double k6;
    @XmlElement(name = "T7", namespace = "http://www.ieee.org/odm/Schema/2008", required = true)
    protected TimePeriodXmlType t7;
    @XmlElement(name = "K7", namespace = "http://www.ieee.org/odm/Schema/2008")
    protected double k7;
    @XmlElement(name = "K8", namespace = "http://www.ieee.org/odm/Schema/2008")
    protected double k8;
