...
public class MutualZeroZXmlType {
    ...
    @XmlElement(name = "zM", namespace = "http://www.ieee.org/odm/Schema/2008")
    protected ZXmlType zm;
    @XmlElement(name = "bIJ1pu", namespace = "http://www.ieee.org/odm/Schema/2008")
    protected Double bij1Pu;
    @XmlElement(name = "bIJ2pu", namespace = "http://www.ieee.org/odm/Schema/2008")
    protected Double bij2Pu;
    @XmlElement(name = "bKL1pu", namespace = "http://www.ieee.org/odm/Schema/2008")
    protected Double bkl1Pu;
    @XmlElement(name = "bKL2pu", namespace = "http://www.ieee.org/odm/Schema/2008")
