    ...
    extends GovernorModelXmlType
{
    ...
    @XmlElement(name = "TG", namespace = "http://www.ieee.org/odm/Schema/2008", required = true)
    protected TimePeriodXmlType tg;
    @XmlElement(name = "TP", namespace = "http://www.ieee.org/odm/Schema/2008", required = true)
    ...
    @XmlElement(name = "SIGMA", namespace = "http://www.ieee.org/odm/Schema/2008")
    protected double sigma;
    @XmlElement(name = "DELTA", namespace = "http://www.ieee.org/odm/Schema/2008")
