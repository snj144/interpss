    ...
    extends GovernorModelXmlType
{
    ...
    @XmlElement(name = "PMAX", namespace = "http://www.ieee.org/odm/Schema/2008", required = true)
    protected String pmax;
    @XmlElement(name = "PMIN", namespace = "http://www.ieee.org/odm/Schema/2008", required = true)
