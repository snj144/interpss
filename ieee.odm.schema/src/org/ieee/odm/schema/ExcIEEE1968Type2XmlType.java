    ...
    extends ExcSimpleTypeXmlType
{
    ...
    protected double kf;
    @XmlElement(name = "TF1", namespace = "http://www.ieee.org/odm/Schema/2008", required = true)
    protected TimePeriodXmlType tf1;
    @XmlElement(name = "TF2", namespace = "http://www.ieee.org/odm/Schema/2008", required = true)
