    ...
    extends StabilizerModelXmlType
{
    ...
    @XmlElement(name = "M", namespace = "http://www.ieee.org/odm/Schema/2008")
    protected int m;
    @XmlElement(name = "N", namespace = "http://www.ieee.org/odm/Schema/2008")
    protected int n;
    ...
    @XmlElement(name = "TW3", namespace = "http://www.ieee.org/odm/Schema/2008", required = true)
    protected TimePeriodXmlType tw3;
    @XmlElement(name = "TW4", namespace = "http://www.ieee.org/odm/Schema/2008", required = true)
    ...
    @XmlElement(name = "KS2", namespace = "http://www.ieee.org/odm/Schema/2008")
    protected double ks2;
    @XmlElement(name = "KS3", namespace = "http://www.ieee.org/odm/Schema/2008")
    protected double ks3;
    @XmlElement(name = "T8", namespace = "http://www.ieee.org/odm/Schema/2008", required = true)
    ...
    @XmlElement(name = "KS1", namespace = "http://www.ieee.org/odm/Schema/2008")
    ...
    @XmlElement(name = "VSTMAX", namespace = "http://www.ieee.org/odm/Schema/2008")
    protected double vstmax;
    @XmlElement(name = "VSTMIN", namespace = "http://www.ieee.org/odm/Schema/2008")
