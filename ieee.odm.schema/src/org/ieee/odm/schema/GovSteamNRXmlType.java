    ...
    extends GovernorModelXmlType
{
    ...
    @XmlElement(name = "Pup", namespace = "http://www.ieee.org/odm/Schema/2008")
    protected double pup;
    @XmlElement(name = "Pdown", namespace = "http://www.ieee.org/odm/Schema/2008")
    protected double pdown;
    @XmlElement(name = "TCH", namespace = "http://www.ieee.org/odm/Schema/2008", required = true)
