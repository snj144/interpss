...
///////////////////////////////////////////////////////////////
    ...
    static void WriteData(String s, String s2, double V){
        String[] Indx = new String[gamsglobals.maxdim];
        double[] Values = new double[gamsglobals.val_max];
        Indx[0] = s; Indx[1] = s2;
        Values[gamsglobals.val_level] = V;
    ...
    static boolean WriteModelData(String fngdxfile){        
        ...
        // write table
        if(gdx.DataWriteStrStart("distance", "distance data", 2, gamsglobals.dt_par, 0) == 0){
            ReportGDXError("DataWriteStrStart");
            return false;    
        }
/*
 ...
 */
        WriteData("seattle", "New-York", 2.5);
        WriteData("seattle", "Chicago" , 1.7);
        WriteData("seattle", "Topeka"  , 1.8);
        WriteData("san-diego", "New-York", 2.5);
        WriteData("san-diego", "Chicago" , 1.8);
        WriteData("san-diego", "Topeka"  , 1.4);
    ...
    static boolean CallGams(String SysDir){
        ...
        opt.SetStrStr("Input", "model\\model3.gms");
