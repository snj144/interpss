 ...
 */
public class AcscModelParser extends BaseAclfModelParser<ShortCircuitNetXmlType, ShortCircuitBusXmlType> {	
	 ...
	 */
	@Override
	public ShortCircuitNetXmlType createBaseCase() {
	 ...
	 * @return
	 */
	public ShortCircuitBusXmlType getAcscBus(String id) throws ODMException {
