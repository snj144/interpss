...
package org.ieee.odm.adapter.dep.xbean.ge.impl;
...
public class XBeanGenDataRec extends XBeanBusHeaderRec {
	...
	public XBeanGenDataRec(String lineStr, XBeanGE_PSLF_Adapter.VersionNo version, final XBeanODMModelParser parser, Logger logger) {
 ...
 */		
		...
		if (st.hasMoreElements()) {
			...
			XBeanNetDataRec.setDates(st1, this.d_in, this.d_out, this.projId);
			...
			XBeanNetDataRec.setOwnerAry(st1, this.oAry, this.pAry);
