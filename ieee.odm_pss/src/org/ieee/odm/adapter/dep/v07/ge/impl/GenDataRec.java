...
public class GenDataRec extends BusHeaderRec {
	...
	public GenDataRec(String lineStr, GE_PSLF_AdapterOld.VersionNo version, 
 ...
 */		
		...
		*/
	    ...
	    contriGen.setRemoteVoltageControlBus(parser.createBusRecRef(AbstractModelParser.BusIdPreFix+this.igregBus));
