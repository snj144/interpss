...
//					parser,this);
	 ...
	 *   ============ 
	 */
	private void processReadComment(final String str, final LoadflowNetXmlType baseCaseNet
			,BPAAdapter adapter){
	...
	private void processAreaData(final String str,final AclfModelParser parser ,
