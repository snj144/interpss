...
public class BPABusRecord {
	...
	public static void processBusData(final String str, AclfModelParser parser) {		
		...
		if(loadMw != 0.0 || loadMvar != 0.0 || 
			...
			if(busType==swingBus){
				...
				if(vpu!=0 ||vMinOrAngDeg!=0){
				    busRec.getGenData().getEquivGen().setVoltageLimit(BaseDataSetter.createVoltageLimit(
