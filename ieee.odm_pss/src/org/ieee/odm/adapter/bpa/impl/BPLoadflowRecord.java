...
public class BPLoadflowRecord {
	...
	public static void processLfData(AclfModelParser parser, final IFileReader din) throws Exception {
...
//						System.out.println(str); //for test
	 ...
	 * @throws ODMException
	 */
	private static void processBranchInfo(List<String> strList, AclfModelParser parser) throws ODMException {
