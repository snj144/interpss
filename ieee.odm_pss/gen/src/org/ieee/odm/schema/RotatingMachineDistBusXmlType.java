 ...
 *                 &lt;sequence>
 *                   &lt;element name="z" type="{http://www.ieee.org/odm/Schema/2008}ZXmlType" maxOccurs="unbounded"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
    ...
    extends NonContributingDistBusXmlType
{
    ...
    public static class Z1List {
         ...
         * 
         */
        public List<ZXmlType> getZ() {
            if (z == null) {
                z = new ArrayList<ZXmlType>();
            }
            return this.z;
        }
