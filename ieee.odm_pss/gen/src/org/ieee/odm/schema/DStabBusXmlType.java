 ...
 *                 &lt;sequence>
 *                   &lt;element name="machine" type="{http://www.ieee.org/odm/Schema/2008}DynamicGeneratorXmlType" maxOccurs="unbounded"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
    ...
    extends ShortCircuitBusXmlType
{
    ...
    public static class MachineList {
        ...
        @XmlElement(required = true)
        protected List<DynamicGeneratorXmlType> machine;
         ...
         * 
         */
        public List<DynamicGeneratorXmlType> getMachine() {
            if (machine == null) {
                machine = new ArrayList<DynamicGeneratorXmlType>();
            }
            return this.machine;
        }
