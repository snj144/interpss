...
public class GPGraphUI extends BasicGraphUI {
	...
	public class GPTransferHandler extends GraphTransferHandler {
		...
		// }
		//
		// Object userObject = new GPUserObject(name, hashtable);//TODO will
		// break custom user object implementation
		...
		// cell = new TextCell(new GPUserObject(s.toString(), props));//TODO
		// will break custom user object implementation
