...
//		super(graphpad.getFrame(), title, true);
	...
	public void selectFile() {
		try {
			NamedInputStream in = com.interpss.editor.util.Utilities.provideInput(Translator.getString("GraphFileExtension"),Translator.getString("GraphFileExtensionDescription"));
			if (in != null) {
				
				setFile(com.interpss.editor.util.Utilities.OpenGraphFile(graphpad,in.getInputStream()));
