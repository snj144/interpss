...
package com.interpss.editor.plugins.util;
...
public class GPOverviewPanel
	 ...
	 */
	public GPOverviewPanel(GPGraphpad pad, JGraph g, GPDocument d) {
		originalGraph = g;
        pad.getCurrentGraph();
		v = new PannerViewfinder(this, d.getScrollPane().getViewport());
		GraphLayoutCache view = new ViewRedirector(g.getGraphLayoutCache());
		
		graph = (JGraph) GPPluginInvoker.instanciateObjectForKey("JGraph.class");
	...
	public static JPanel createOverviewPanel(GPGraphpad pad, JGraph g, GPDocument d, GPOverviewPanel gpOverviewPanel){
	...
	public static JPanel createOverviewPanel(GPGraphpad pad, JGraph g, GPDocument d){
		JPanel panelWithInternalOffset = new JPanel();
		panelWithInternalOffset.setLayout(new BorderLayout());
		panelWithInternalOffset.setBorder(new MatteBorder(PANEL_BUFFER,PANEL_BUFFER,PANEL_BUFFER,PANEL_BUFFER,Color.WHITE));
		panelWithInternalOffset.add(new GPOverviewPanel(pad, g,d), BorderLayout.CENTER);
		return panelWithInternalOffset;
	}
