...
*/	
	...
	private static void setExciterInfo(DStabMachData machData, Machine mach, IPSSMsgHub msg) {
		...
		Controller controller = (Controller)SimuSpringAppCtxUtil.getExciter(excData.getTypeName());
   		if (controller != null) {
	...
	private static void setGovernorInfo(DStabGovData govData, Machine mach, IPSSMsgHub msg) {
   		...
   		Controller controller = (Controller)SimuSpringAppCtxUtil.getGovernor(govData.getTypeName());
		if (controller != null) {
	...
	private static void setStabilizerInfo(DStabPssData pssData, Machine mach, IPSSMsgHub msg) {
   		...
   		Controller controller = (Controller)SimuSpringAppCtxUtil.getStabilizer(pssData.getTypeName());
   		if (controller != null) {
