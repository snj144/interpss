...
public class SeFunction extends FunctionAdapter {
	...
	public SeFunction(double e1, double se_e1, double e2, double se_e2) throws Exception {
		if (e1 <= e2 || se_e1 <= se_e2) {
			throw new Exception("Se(Efd) data error, E1, Se(E1), E2, Se(E2): " + e1 + ", "  + se_e1 + ", " + e2 + ", "  + se_e2);
		}
		this.e1 = e1;
		this.se_e1 = se_e1;
		this.e2 = e2;
	...
	public String toString() {
		String str = "E1, Se(E1), E2, Se(E2): " + e1 + ", "  + se_e1 + ", " + e2 + ", "  + se_e2;
		str += "A, B: " + a + ", "  + b;
		return str;
	}	
}
