...
public class IeeePSS2AStabilizer extends AnnotateStabilizer {
	...
	// UI Editor panel
	private static final NBIeeePSS2AStabilizerEditPanel _editPanel = new NBIeeePSS2AStabilizerEditPanel();
	
	public IeeePSS2AStabilizer() {
