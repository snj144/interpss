...
public class NBIeeeSteamTDSREditPanel extends javax.swing.JPanel implements IControllerEditor {
	...
	*/
    public boolean setData2Editor() {
    	...
    	EditUtilFunct.setDblTextFiled(trh1TextField, 	_data.getTrh1(), "#0.000");
    	EditUtilFunct.setDblTextFiled(trh2TextField, 	_data.getTrh2(), "#0.000");
    	EditUtilFunct.setDblTextFiled(tcoTextField, _data.getTco(), "#0.00");
    	EditUtilFunct.setDblTextFiled(fvhpTextField, _data.getFvhp(), "#0.000");
	...
	*/
    public boolean saveEditorData(Vector<String> errMsg) throws Exception {
    	...
    	EditUtilFunct.saveDblTextField(_data, trh1TextField, "trh1", errMsg);
    	EditUtilFunct.saveDblTextField(_data, trh2TextField, "trh2", errMsg);
    	EditUtilFunct.saveDblTextField(_data, tcoTextField, "tco", errMsg);
    	EditUtilFunct.saveDblTextField(_data, fvhpTextField, "fvhp", errMsg);
			...
			if (input == null)
       		...
       		try {
    			...
    			if ( input == trh1TextField)
    				return EditUtilFunct.checkIntDataRange(input, _data, "trh1");
    			if ( input == trh2TextField)
    				return EditUtilFunct.checkIntDataRange(input, _data, "trh2");
    			if ( input == tcoTextField)
    				return EditUtilFunct.checkDblDataRange(input, _data, "tco");
    			if ( input == fvhpTextField)
    				return EditUtilFunct.checkDblDataRange(input, _data, "fvhp");
    			if ( input == fhpTextField)
    				return EditUtilFunct.checkDblDataRange(input, _data, "fhp");
    			if ( input == fipTextField)
    				return EditUtilFunct.checkDblDataRange(input, _data, "fip");
    			if ( input == flpTextField)
    				return EditUtilFunct.checkDblDataRange(input, _data, "flp");
 	       	} catch (Exception e) {
 	    		return false;
 	       	}		
			return true;
