...
public class BusDataRec extends BusHeaderRec {
	...
	public BusDataRec(String lineStr, GE_PSLF_AdapterOld.VersionNo version, final JaxbODMModelParser parser, Logger logger) {
/*
 ...
 */
		...
		try {
			busRec = parser.createBusRecord(busId, this.number);
		} catch (Exception e) {
