...
public class SwingInputVerifyUtil {
	...
	public static boolean largeThan(javax.swing.JTextField input, double x)	throws Exception {
		...
		double d = NumberFormat.getInstance().parse(input.getText()).doubleValue();
		if (d > x)
			return true;
		return false;
	}
	 ...
	 * @return true or false
	 */
	public static boolean largeThan(javax.swing.JTextField input, double x,	Vector<String> errMsgList, String errMsg) throws Exception {
...
//		int d = new Integer(input.getText()).intValue();
		int d = NumberFormat.getInstance().parse(input.getText()).intValue();		
		if (d > x)
			return true;
		return false;
	}
...
//		double d = new Double((String) (input.getSelectedItem())).doubleValue();
		double d = NumberFormat.getInstance().parse(input.getSelectedItem().toString()).doubleValue();		
		if (d > x)
			return true;
		return false;
	}
...
//		double d = new Double(input.getText()).doubleValue();
	 ...
	 * @return the double number
	 */
	public static double getDouble(Object input) throws Exception{
		return NumberFormat.getInstance().parse(input.toString()).doubleValue();
//		return ((Double) (input)).doubleValue();
	...
	public static double getDouble(javax.swing.JComboBox input)	throws Exception {
		return NumberFormat.getInstance().parse(input.getSelectedItem().toString()).doubleValue();
//		return new Double((String) (input.getSelectedItem())).doubleValue();
	...
	public static int getInt(javax.swing.JTextField input) throws Exception {
		return NumberFormat.getInstance().parse(input.getText()).intValue();
