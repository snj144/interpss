...
//		super(graphpad.getFrame(), title, true);
		super(graphpad.getFrame(), Translator.getString("GraphDialog.Text"), true);
	...
	protected void initGuiComponents() {
		...
		newRadioButton.setMnemonic(Translator.getString("GraphDialog.CreateANewGraphicProject.Mnemonic").toCharArray()[0]);
		...
		fromRadioButton.setMnemonic(Translator.getString("GraphDialog.ImportAGraphicProjectFromExistingSource.Mnemonic").toCharArray()[0]);
