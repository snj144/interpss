...
public class SCGrid_TestCase2_2009TestCases extends QATestSetup {
	...
	public void testCase1() throws Exception {
		...
		new FileReader("output/psse/SCGrid_TestCase2_2009_raw_01192011.txt")
				.processFile(proc);		
		//System.out.println("Total bus: " + proc.getTotalBus());
		assertTrue(proc.getTotalBus() == 659);
		
		if (proc.getErrMsgList().size() > 0) {
			System.out.println("SCGrid_TestCase2_2009_raw");
