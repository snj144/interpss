...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Ipss Project Item Group</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.interpss.editor.ws.impl.IpssProjectItemGroupImpl#getProjDbId <em>Proj Db Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class IpssProjectItemGroupImpl extends IpssWsItemContainerImpl implements IpssProjectItemGroup {
	/**
	 ...
	 * @generated
	 */
	protected IpssProjectItemGroupImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return IpssWsPackage.Literals.IPSS_PROJECT_ITEM_GROUP;
	}
	...
	public void setProjDbId(int newProjDbId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IpssWsPackage.IPSS_PROJECT_ITEM_GROUP__PROJ_DB_ID, oldProjDbId, projDbId));
	}
	 ...
	 * @generated NOT
	 */
	public IpssProject getParanetProject() {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IpssWsPackage.IPSS_PROJECT_ITEM_GROUP__PROJ_DB_ID:
