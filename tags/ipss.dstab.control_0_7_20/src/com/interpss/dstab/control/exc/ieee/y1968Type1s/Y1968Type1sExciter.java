...
public class Y1968Type1sExciter extends AbstractExciter {
	...
	private static final NBY1968Type1sExciterEditPanel _editPanel = new NBY1968Type1sExciterEditPanel();
	
	/**
	 * Default Constructor
	 *
	 */
	public Y1968Type1sExciter() {
	 ...
	 */
	public Y1968Type1sExciter(final String id, final String name) {
		super(id, name);
		// _data is defined in the parent class. However we must be reference to an actual object
		_data = new Y1968Type1sExciterData();
	}
	 ...
	 */
	public Y1968Type1sExciterData getData() {
		return (Y1968Type1sExciterData)_data;
	}
	...
	public void setDataXmlString(final String xmlString) {
		...
		_data = XmlUtil.toObject(xmlString, Y1968Type1sExciterData.class);
	}
