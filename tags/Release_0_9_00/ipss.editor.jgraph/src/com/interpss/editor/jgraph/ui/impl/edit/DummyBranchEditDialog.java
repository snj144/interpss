package com.interpss.editor.jgraph.ui.impl.edit;
...
import com.interpss.editor.jgraph.ui.impl.form.DummyBranchForm;
import com.interpss.editor.jgraph.ui.impl.form.DummyFormContainer;
...
public class DummyBranchEditDialog extends javax.swing.JDialog  implements IFormDataDialog {
    ...
    private DummyBranchForm  _form = null;
	...
	*/
    public DummyBranchEditDialog(java.awt.Frame parent, IPSSMsgHub aMsgHub) {
	...
	*/
    ...
    public DummyBranchEditDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
