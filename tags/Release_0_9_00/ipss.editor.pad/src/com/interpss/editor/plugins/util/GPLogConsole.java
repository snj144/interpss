...
import com.interpss.editor.util.NamedOutputStream;
...
public class GPLogConsole extends JFrame {
	...
	private static GPLogConsole instance;
	...
	public static GPLogConsole getInstance() {
		if (instance == null)
			instance = new GPLogConsole();
		return instance;
	}
	...
	private void jbInit() throws Exception {
		...
		jTabbedPane1.add(stdoutScrollPane, Translator.getString("StandardOut"/*
																				 * #Finished:Original="Standard
																				 * out"
																				 */));
		jTabbedPane1.add(stderrScrollPane, Translator.getString("StandardError"/*
																				 * #Finished:Original="Standard
																				 * error"
																				 */));
		...
		jMenuItemSendEmail
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						GPPluginInvoker.openURL("mailto:" + email + subj + msg);
					}
				});
