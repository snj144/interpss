 ...
 */
public class ViewScaleZoomIn extends IpssAbstractGraphAction {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (graphpad.getCurrentGraph().getScale() < 8) {
			...
			getCurrentDocument().setScale(
					graphpad.getCurrentGraph().getScale() * 2);
			if (graphpad.getCurrentGraph().getSelectionCell() != null)
				graphpad.getCurrentGraph().scrollCellToVisible(
