...
import com.interpss.editor.resources.TranslatorConstants;
import com.interpss.editor.util.BarEntry;
import com.interpss.editor.util.ICommandRegistery;
...
public class GPBarFactory implements TranslatorConstants {
	...
	public static final String ROOT_POPUP = "RootPopup";

	public static final String PROJECT_POPUP = "ProjectPopup";

	public static final String PROJECTITEM_POPUP = "ProjectItemPopup";
...
//			}
	...
	protected Component[] createMenuItem(final String cmd,
		...
		if (a instanceof IpssAbstractGraphAction) {
			return ((IpssAbstractGraphAction) a).getMenuComponents();
		}
	...
	public JPopupMenu createRootPopupMenu(
			final ICommandRegistery actionRegistery) {
		return createPopupMenu(ROOT_POPUP, actionRegistery);
	}

	public JPopupMenu createProjectPopupMenu(
			final ICommandRegistery actionRegistery) {
		return createPopupMenu(PROJECT_POPUP, actionRegistery);
	}
	
	public JPopupMenu createProjectItemPopupMenu(
			final ICommandRegistery actionRegistery) {
		return createPopupMenu(PROJECTITEM_POPUP, actionRegistery);
	}
	...
	protected Component[] createToolbarButton(final String key,
		...
		if (a instanceof IpssAbstractGraphAction) {
			return ((IpssAbstractGraphAction) a).getToolComponents();
		}
