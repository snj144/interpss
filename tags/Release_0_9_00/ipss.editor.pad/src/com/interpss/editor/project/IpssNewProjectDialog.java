...
public class IpssNewProjectDialog extends javax.swing.JDialog {
	...
	protected void initGuiComponents() {
		...
		newRadioButton.setText("Create new project folder in Workspace");
		...
		fromRadioButton
				.setText("Create project folder from existing source");
		...
		nameLabel.setText("Project Folder Name:");
	...
	public void updateState() {
		...
		try {
			...
			showError("Create project error:" + e.getMessage());
			return;
		}
