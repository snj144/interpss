...
public class TreePackageImpl extends EPackageImpl implements TreePackage {
	 ...
	 * @see org.interpss.model.tests.Tree.TreePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getNode_ChildList() {
	...
	public void createPackageContents() {
		...
		createEReference(nodeEClass, NODE__CHILD_LIST);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getNode_Label(), ecorePackage.getEString(), "label", "\"Not defined\"", 0, 1, Node.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		EGenericType g1 = createEGenericType(this.getNode());
		EGenericType g2 = createEGenericType(nodeEClass_T);
		g1.getETypeArguments().add(g2);
		initEReference(getNode_ChildList(), g1, this.getNode_Parent(), "childList", null, 0, -1, Node.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getNode_ChildList().getEKeys().add(this.getNode_Label());
		g1 = createEGenericType(this.getNode());
		g2 = createEGenericType(nodeEClass_T);
		g1.getETypeArguments().add(g2);
		initEReference(getNode_Parent(), g1, this.getNode_ChildList(), "parent", null, 0, 1, Node.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		g1 = createEGenericType(nodeEClass_T);
		initEAttribute(getNode_Data(), g1, "data", null, 0, 1, Node.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
