 ...
 * <ul>
 *   <li>{@link org.interpss.model.editor.doc.impl.IpssEditableDocumentImpl#isModified <em>Modified</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class IpssEditableDocumentImpl<TEditor, TViewer> extends IpssEditorDocumentImpl<TViewer> implements IpssEditableDocument<TEditor, TViewer> {
	/**
	...
	protected EClass eStaticClass() {
		return docPackage.Literals.IPSS_EDITABLE_DOCUMENT;
	}
	...
	public void setModified(boolean newModified) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, docPackage.IPSS_EDITABLE_DOCUMENT__MODIFIED, oldModified, modified));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case docPackage.IPSS_EDITABLE_DOCUMENT__MODIFIED:
