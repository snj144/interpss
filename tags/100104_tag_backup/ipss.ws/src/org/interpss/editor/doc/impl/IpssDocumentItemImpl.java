...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Ipss Document Item</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.interpss.editor.doc.impl.IpssDocumentItemImpl#getWsItem <em>Ws Item</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class IpssDocumentItemImpl extends IpssDocumentImpl implements IpssDocumentItem {
	/**
	 ...
	 * @generated
	 */
	protected IpssDocumentItemImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return IpssDocPackage.Literals.IPSS_DOCUMENT_ITEM;
	}
		...
		if (wsItem != null && wsItem.eIsProxy()) {
			...
			if (wsItem != oldWsItem) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, IpssDocPackage.IPSS_DOCUMENT_ITEM__WS_ITEM, oldWsItem, wsItem));
			}
		}
		return wsItem;
	}
	...
	public NotificationChain basicSetWsItem(IpssWsItem newWsItem, NotificationChain msgs) {
		...
		wsItem = newWsItem;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IpssDocPackage.IPSS_DOCUMENT_ITEM__WS_ITEM, oldWsItem, newWsItem);
	...
	public void setWsItem(IpssWsItem newWsItem) {
		if (newWsItem != wsItem) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, IpssDocPackage.IPSS_DOCUMENT_ITEM__WS_ITEM, newWsItem, newWsItem));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case IpssDocPackage.IPSS_DOCUMENT_ITEM__WS_ITEM:
				if (wsItem != null)
					msgs = ((InternalEObject)wsItem).eInverseRemove(this, IpssWsPackage.IPSS_WS_ITEM__IPSS_DOC, IpssWsItem.class, msgs);
