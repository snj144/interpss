...
public class CostPerHeatUnit extends DoubleType {
	public CostPerHeatUnit(double value) {
		super(value, Units.uocMBtu);
	}

	@AnInitConstructor
	public CostPerHeatUnit(String str) {
		super(str);
	}
}
