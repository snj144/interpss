 ...
 */
public class ShapeGroup extends IpssAbstractGraphAction {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (!graph.isSelectionEmpty()) {
			DefaultGraphCell group = new DefaultGraphCell(GPPluginInvoker.instanciateObjectForKey("UserObject.class"));
