 ...
 */
public abstract class IpssAbstractActionDefault
	 ...
	 *
	 */
	public IpssAbstractActionDefault() {
	 ...
	 *
	 */
	public IpssAbstractActionDefault(GPGraphpad graphpad) {
	...
	public IpssAbstractActionDefault(GPGraphpad graphpad, String name) {
		super(name);
		this.graphpad = graphpad;
	}
	...
	public IpssAbstractActionDefault(GPGraphpad graphpad, String name, Icon icon) {
		super(name, icon);
		this.graphpad = graphpad;
	}
	...
	public IpssAbstractActionDefault(String name, Icon icon) {
		super(name, icon);
	}
