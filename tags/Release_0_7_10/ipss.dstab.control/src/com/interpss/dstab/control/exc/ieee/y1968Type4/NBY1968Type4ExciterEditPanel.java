...
public class NBY1968Type4ExciterEditPanel extends javax.swing.JPanel implements IControllerEditor {
	private static final long serialVersionUID = 1;

	// define data to be edited
	Y1968Type4ExciterData _data;

    /** Creates new form FaultLocDataPanel */
    public NBY1968Type4ExciterEditPanel() {
        initComponents();
	...
	public void init(Object controller) {
		...
		_data = ((Y1968Type4Exciter)controller).getData();
	}
