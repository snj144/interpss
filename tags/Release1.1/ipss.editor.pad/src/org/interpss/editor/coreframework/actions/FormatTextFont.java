...
import org.interpss.editor.swing.JFontChooser;
import org.jgraph.graph.AttributeMap;
import org.jgraph.graph.GraphConstants;


public class FormatTextFont extends IpssAbstractGraphAction {
			...
			if (getCurrentGraph().getSelectionCount() > 0) {
				Font value =
					JFontChooser.showDialog(
						graphpad.getFrame(),
						Translator.getString("FontDialog"),
						null);
				if (value != null) {
					AttributeMap map = new AttributeMap();
					GraphConstants.setFont(map, value);
