...
public class CloseAndMaxTabbedPane extends JTabbedPane {
	...
	public final static byte UI_BASIC=0,UI_ENHANCED=1,UI_ECLIPSE=2,UI_IPSS=3;
	 ...
	 */
	public CloseAndMaxTabbedPane(byte uitype) {
		...
		case UI_ENHANCED:
			...
			break;
		case UI_ECLIPSE:
			paneUI = new CloseTabPaneEclipseUI();
			break;
		case UI_IPSS:
			paneUI = new CloseTabPaneIpssUI();
			break;
		default:
			paneUI = new CloseTabPaneUI();
		}
