...
public class RunTranCapacityAnalysisGenShiftFactor extends IpssAbstractActionDefault {
	...
	public void actionPerformed(ActionEvent e) {
		RunUtilFunc.performRunAction(getCurrentDocument(), EditorActionAdapter.RunType.GenShiftFactor, graphpad);
	}
