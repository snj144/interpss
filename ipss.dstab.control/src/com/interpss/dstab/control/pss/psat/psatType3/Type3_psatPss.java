...
package com.interpss.dstab.control.pss.psat.psatType3;
...
public class Type3_psatPss extends AbstractStabilizer {
	// state variables
	private double 	x1 = 0.0, x2 = 0.0;
	private LimitType limit = null;

	// UI Editor panel
	private static final NBType3_psatPssEditPanel _editPanel = new NBType3_psatPssEditPanel();
	
	public Type3_psatPss() {
	 ...
	 * @param name pss name
	 */	
	public Type3_psatPss(final String id, final String name) {
		super(id, name);
		// _data is defined in the parent class. However init it here is a MUST
		_data = new Type3_psatPssData();
	}
	 ...
	 */
	public Type3_psatPssData getData() {
		return (Type3_psatPssData)_data;
	}
	...
	public void setDataXmlString(final String xmlString) {
		...
		_data = XmlUtil.toObject(xmlString, Type3_psatPssData.class);
	}
