...
package com.interpss.dstab.control.gov.psat.psatType2;
...
public class Type2_pastGov extends AbstractGovernor {
	// state variables
	private double pm0 = 0.0, x1 = 0.0;
	private LimitType limit = null;
	
	// UI Editor panel
	private static final NBType2_pastGovEditPanel _editPanel = new NBType2_pastGovEditPanel();

	/**
	 * Default Constructor
	 *
	 */
	public Type2_pastGov() {
	 ...
	 */	
	public Type2_pastGov(final String id, final String name) {
		super(id, name);
		// _data is defined in the parent class. However init it here is a MUST
		_data = new Type2_pastGovData();
	}
	 ...
	 */
	public Type2_pastGovData getData() {
		return (Type2_pastGovData)_data;
	}
	...
	public void setDataXmlString(final String xmlString) {
		...
		_data = XmlUtil.toObject(xmlString, Type2_pastGovData.class);
	}
