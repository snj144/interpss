...
public class Type1_psatAvr extends AbstractExciter {
	...
	private static final NBType1_psatAvrEditPanel _editPanel = new NBType1_psatAvrEditPanel();
	
	/**
	 * Default Constructor
	 *
	 */
	public Type1_psatAvr() {
		this("excId", "PSAT_AVR_TYPE1"); 
	}
	 ...
	 */
	public Type1_psatAvrData getData() {
		return (Type1_psatAvrData)_data;
	}
	...
	public void setDataXmlString(final String xmlString) {
		...
		_data = XmlUtil.toObject(xmlString, Type1_psatAvrData.class);
	}
